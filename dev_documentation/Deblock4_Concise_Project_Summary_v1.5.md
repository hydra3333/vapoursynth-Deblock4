...
T1            IN PROGRESS. Formal consolidation sweep of the MPEG-2-bearing
              ...
              THE MPEG-2 AUTHORITY IS BEING ADJUDICATED IN DECLARED
              SUB-TRANCHES, the last of which is declared FINAL because
              whole-document consistency is checked there and nowhere
              earlier. FOR WHICH SUB-TRANCHE IS LIVE AND WHAT IS OWED, READ
              Deblock4_T1_Resume_Brief SECTION 0a (highest committed
              version). This document is not maintained for that and will
              stale between sub-tranches.
              NOTHING HAS BEEN RATIFIED INTO ANY AUTHORITY DOCUMENT. Every
              ledger remedy is a PROPOSAL; the MPEG-2 authority is still
              v1.05 and that is deliberate.
