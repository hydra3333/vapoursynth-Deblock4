...
**Design specification revision:** 1.5  
**Date:** 2026-07-29  
...
Deblock4Backend       : data    same token as Deblock4Tier (the backend actually used)
...
- `Deblock4Backend`/`Deblock4Tier` record the level actually used, using the
  exact tokens of charter G1; `"auto"` is never written (the resolved level is).
