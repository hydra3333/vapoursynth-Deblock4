...
Charter:
    filename          Deblock4_AI_Charter_and_Invariants_Card_v1.3.md
...
- Added C-MEM-01 so frame construction considers safe plane sharing, exact
  ...
  implementation mechanism as an output invariant. Specialised SIMD copy
  backends now require demonstrated need and measurement.
