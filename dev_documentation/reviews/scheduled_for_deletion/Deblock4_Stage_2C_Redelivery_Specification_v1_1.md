...
.cmd. No delivery/validation machinery invokes git (section 5 wording).
...
- The statement (F-3 corrected form): no executable delivery or
  validation machinery invokes git; git commands appear ONLY in the
  manifest's optional MANUAL W3X backout block.
