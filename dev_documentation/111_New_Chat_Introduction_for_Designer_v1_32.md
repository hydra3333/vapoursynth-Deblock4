...
DESIGNER ROLE NOW:
 ...
 - Next designer work is T1S01a5b, NOT a5 AND NOT T8/T5/T6. T1S01a5 IS
   ...
   RATIFIED consolidated method (DEC-83/84). Before writing ONE a5b entry:
   read its section 0 end to end, derive a5b's own population, and produce
   the SOURCE-COVERAGE MAP BEFORE adjudication (DEC-77 / scope 0.10). Resume
   Brief sections 0a and 0f carry the a5b expectations - it is the HARDER,
