...
4. Deblock4_Project_Status_v1_13.md                 INFORMATIVE
...
6. Deblock4_Toolchain_Findings_v1_1.md              INFORMATIVE
   ...
   the proven multi-feature-level dispatch idiom that the filter-creation stage follows.
...
10. 111_New_Chat_Introduction_for_Coder_v1_12.md    INFORMATIVE
...
- filter-creation entry point and dispatch WIRING that consumes the proven
  EFFECTIVE record (the record and the detector are DONE in 1B.3)
...
4. The precise state of the coder handover - the coder introduction
   (111_New_Chat_Introduction_for_Coder_v1_12.md) is current and reconciled
