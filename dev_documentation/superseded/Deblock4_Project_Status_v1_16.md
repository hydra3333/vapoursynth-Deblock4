...
Stage 1 - Zig project / build / dispatch / tiering scaffold and spikes (SHARED)
    ...
    ACTIVE Stage 1C Phase 3a: frame path (mechanics, property modules, tier-
          ...
          registration - about to be received for W3D review. The review is
          governed by the Phase 3a REVIEW SET (charter 2.3a version group, read
          together, latest of each prevailing): scope v1_5 + delivery addendum
          v1_1 + Phase 3a Designer Briefing v1_0. Phase 3b (sweep, build_1C
          batch, .vpy harnesses, full proof matrix) follows.
