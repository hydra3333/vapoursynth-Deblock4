...
**Version:** 1.4
**Date:** 2026-07-29
**Status:** Orientation only; not controlling; not a coding scope. Aligned to charter v1.12, README v1.5.
**Author:** W3D designer
...
Status (v1.4): Stages 1A, 1A.1 and 1B.1 are COMPLETE and committed. Stage 1B.2
...
Classic series (2C..5C) first, then a Deblock4 series (2D..5D). See README v1.5
section 1.0/20 and Deblock4_Verification_And_Tiering_Decisions section 8. The
...
Stage 1B.2   ACTIVE - confirm each object stays WITHIN its named psABI level.
             ...
             and that dispatch checks the whole level, and settles the AVX/SSE
...
1B.2 after 1B.1
    ...
    assembly inspection that each object emits nothing outside its level and
    that the guard checks the whole level. 1B.1 proved the multi-object
    STRUCTURE; 1B.2 confirms it stays in-bounds.
