...
Stage 1 - Zig project / build / dispatch / tiering scaffold and spikes (SHARED)
    ...
    ACTIVE filter-creation stage: VS entry point, scaffolding sweep (retiring
          the probe/smoke/dll_probe files per C-STY-10), dispatch wiring that
          CONSUMES the EFFECTIVE record to select a backend
...
demand. Accepted and committed; standing batch build_1B3 (final revision). It
