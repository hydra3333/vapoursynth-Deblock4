...
method; W3D v1.3 outgoing-designer evidence absorbed
...
```text
  T1        Formal consolidation sweep ......... RELEASE PENDING - FIRST IN
...
PR-1  R4 - THE IN-PRINCIPLE FALSE-ACTIVATION LIMIT MAY BE UNIVERSAL, AND IS
...
PR-2  S5 - THE tc0-UNSCALED PRINCIPLE HAS DEGRADED FROM PRINCIPLE TO HISTORY.
