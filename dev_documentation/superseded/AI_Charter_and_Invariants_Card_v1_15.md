...
**Version:** 1.15
**Date:** 2026-07-29
**Status:** W3X-ratified. Part 1 carries invariants G1-G9. v1.14 corrects the mandatory bootstrap (per-type acceptance + oracle-construction exception, closing the reinstated byte-identity and the circular oracle rule), splits Stage 1B.2/1B.3 in G3, clarifies OSXSAVE level-membership vs runtime safety, and softens FMA wording.
**Companion specification:** `README_Deblock4_Design_Spec_v1_8.md`
**Companion internal revision:** `Design specification revision: 1.8`
...
Charter:
    filename          AI_Charter_and_Invariants_Card_v1_15.md
    internal version  1.15

Controlling specification:
    filename          README_Deblock4_Design_Spec_v1_8.md
    internal revision Design specification revision: 1.8
...
G3  Backends are compiled for NAMED x86-64 psABI microarchitecture LEVELS,
    ...
    that standard (prefer Zig std.Target's own level definitions, so target and
    detection cannot drift). Because dispatch is WHOLE-LEVEL, an incomplete
