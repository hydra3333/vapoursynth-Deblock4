...
Status (v1.16): Stages 1A..1C COMPLETE and committed. Stage 1C closed with
delivery v1_13 (G6 export fix): full fifteen-gate proof matrix green in all
three modes; both filters proven live under R78 with byte-identical
pass-through. Next bounded step when W3X releases it: rider 1C.1 (the "using"
invocation echo, Deblock4_Scope_Stage_1C1_Rider_Using_Echo_v1_0.md), then
Stage 2C.
