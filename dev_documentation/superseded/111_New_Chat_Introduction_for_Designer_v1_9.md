...
Immediate designer action:
    ...
    the Deblock4_Stage_1C_Delivery_Plan_Addendum_v1_0.md splits it into three
    phases. Phase 1 (pure foundation) has been delivered by W3C, reviewed by
    W3D, and accepted (green on the real toolchain). The immediate designer
    work is to REVIEW Phase 2 when W3C delivers it (backend_tier_selection +
    the two *_instance_creation modules + constant-format refusal), then Phase
    3 (frame path, plugin registration, scaffolding sweep, full proof matrix).
    Verify each delivery against the scope with file and line; W3X releases
    phases and commits, W3D does not. Three hard-won lessons to carry forward.
...
4. Deblock4_Project_Status_v1_14.md                 INFORMATIVE
   Read for the current proof state, what is done, what is open, and why
   Stage 1B.3 complete; Stage 1C active - scope v1_5 ratified, Phase 1 accepted,
...
9a. Deblock4_Forward_Roadmap_v1_12.md               INFORMATIVE
...
11a. Scopes/Deblock4_Stage_1C_Delivery_Plan_Addendum_v1_0.md  CONTROLLING
    The phase delivery order (Phase 1 accepted; Phase 2 next).
...
- (Stage 1C, IN DELIVERY, not an open spike: the filter-creation entry point
  ...
  Phase 1 accepted, Phases 2-3 pending)
...
3. Current position: Stages 1A..1B.3 complete and committed; Stage 1C ACTIVE
   (scope v1_5 ratified; Phase 1 accepted; Phase 2 next); charter v1.20,
   README v1.9 (or whatever you actually received - state it).
4. Immediate designer action:
    Review W3C's Stage 1C Phase 2 delivery when it arrives, against scope v1_5
    and the delivery addendum, verifying with file and line. Then Phase 3.
    W3X releases phases and commits; W3D reviews and verifies, does not.
