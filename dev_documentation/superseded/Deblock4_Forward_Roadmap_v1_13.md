...
Status (v1.13): Stages 1A..1B.3 COMPLETE and committed. Stage 1C (filter
creation) is ACTIVE in phased delivery: Phase 1 (pure foundation) and Phase 2
(tier selection + instance creation + permanent-skeleton routers) are accepted
and committed; Phase 3a (frame path + real plugin registration) is about to be
received for review; Phase 3b (sweep + full proof matrix) follows.
...
Stage 1C ACTIVE  - filter creation, phased (scope v1_5, addendum v1_1).
             ...
             (frame path + real deblock4_plugin registration) about to be
             reviewed; Phase 3b (scaffolding sweep per C-STY-10, build_1C batch,
