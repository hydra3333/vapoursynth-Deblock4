...
Status (v1.19): Stages 1A..1C (incl. rider 1C.1 using-echo), 2C AND 4C are
COMPLETE, accepted and committed; identity 0.1.0-dev+4C. The committed 2C
scalar path is the Classic ORACLE; the 4C SSE4.1 vector backend is proven
byte-identical to it. Stage 3C was COLLAPSED (T-1 deferred to a later
quality phase). Next bounded step: Stage 5C (Classic AVX2 backend), not yet
scoped. Current detail: Project Status v1_26 (or later), section 0.
