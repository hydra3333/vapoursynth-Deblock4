...
Revision: v1.1 (2026-08-02) appended K19 (three-layer comparison doctrine:
general not-bit-exact / Classic byte-exact-target-investigate / internal
byte-identical), prompted by W3X recall check before D1. v1.0 was the
initial index, items K1-K18.
