...
TOP LEVEL (dev_documentation/):
  AI_Charter_and_Invariants_Card_v1_27          the rulebook; PREVAILS
  111_New_Chat_Introduction_for_Coder_v1_25     FULL v1_21 content + post-4C
  ...
  Deblock4_Forward_Roadmap_v1_18                3C collapsed / 4C accepted
  README_Deblock4_Design_Spec_v1_11             12.5 example now 4C-true
  Deblock4_Verification_And_Tiering_Decisions_v1_11
  Deblock4_Toolchain_Findings_v1_4              (single copy; see s3 tidy)
  Deblock4_MPEG2_Grid_Field_DCT_Knowledge_v1_1  normative citation + GAIS list
  ...
  Deblock4_Session_Bootstrap_Header_v1_0        NEW stage-agnostic filename
...
(Earlier today: coder intro v1_25; designer intro v1_20; status v1_26;
roadmap v1_18; acceptance review v1_0; commit message.)

CHECKED, CURRENT, NO CHANGE NEEDED:
  charter v1_27; V&T v1_11; Toolchain Findings v1_4; MPEG-2 knowledge v1_1;
...
charter v1_27 - follow the charter and the Session Bootstrap Header v1_2,
...
```text
1. 111_New_Chat_Introduction_for_Coder_v1_25      (orientation; read first)
2. AI_Charter_and_Invariants_Card_v1_27           (the rulebook; prevails)
3. Deblock4_Session_Bootstrap_Header_v1_0         (base + environment)
