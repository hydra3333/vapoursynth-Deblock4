...
## 2.3 `AI_Charter_and_Invariants_Card_v1_21.md` - CONTROLLING
...
Read these last, together. The scope is the Stage 1C design authority (module
map, dispatch architecture, proof matrix, gap resolutions C1-C9/P1-P5); the
addendum governs PHASE DELIVERY ORDER (read the whole scope for context, deliver
only the released phase). The starting point is the prevailing branch-main
source (no commit id; upload-if-unsure). Do not write production code from this
introduction alone. Phase 1 is accepted; Phase 2 is the next released phase.
...
AI_Charter_and_Invariants_Card_v1_21.md
