# Deblock4 - New Chat Introduction for Coder (v1.29)

```text
CURRENT SUCCESSOR BOOTSTRAP - 2026-08-16 - READ THIS FIRST

READ IN THIS ORDER FOR CURRENT STATE:

    1. Deblock4_Project_Status_v1_28.md section 0
    2. Deblock4_MPEG2_Deblocking_Investigation_and_Decided_Architecture_v1_04.md
       section 0 CURRENT ARCHITECTURE POSITION
    3. the current charter / active bounded scope when W3X issues one
...
set INCLUDING THIS INTRODUCTION. Where this introduction and v1.04 disagree,
v1.04 WINS.
...
W3X-ratified MPEG-2 authority v1.04. The immediate next work is the D4-Q14
architecture-discriminator experiment plan and then the experiment itself.
W3X may ask W3C to cross-check detector/boundary mathematics, source/tooling
feasibility or a bounded experiment implementation, but **do not write a
...
Project Status v1.28 section 0
    ...
    -> D4-Q14 experiment-plan / active scope supplied by W3X
```
...
## 2.1 `Deblock4_Project_Status_v1_28.md` (or later) - INFORMATIVE
...
question, v1.04 of the MPEG-2 authority below prevails.
...
## 2.7 `Deblock4_MPEG2_Deblocking_Investigation_and_Decided_Architecture_v1_04.md` - PREVAILING MPEG-2 AUTHORITY
...
gated by the D4-Q14 ground-truth experiment in MPEG-2 authority v1.04.
...
4. That MPEG-2 authority v1.04 is W3X-ratified. Its historical draft header may
...
6. The exact D4-Q14 experiment-plan generation and its ground-truth extraction
   method. `mediainfo --Details=1` is picture-level regime triage, not per-MB
   dct_type truth.
...
2. Confirmation that Project Status v1.28 (or later) is the live state and
   MPEG-2 authority v1.04 (or later) is the W3X-ratified MPEG-2 source of truth.
...
algorithm authority; v1.04 supersedes it. Historical Classic/Stage-1C proof
...
v1.29 (2026-08-16) Current-state/MPEG-2 authority reconciliation after W3X
      ratified MPEG-2 architecture authority v1.04 and Project Status v1.28.
      ...
      Status v1.28 section 0 -> MPEG-2 v1.04 section 0 -> Q14/active scope;
...
and W3X-ratified MPEG-2 authority v1.04; see section 10 for the detailed note.
