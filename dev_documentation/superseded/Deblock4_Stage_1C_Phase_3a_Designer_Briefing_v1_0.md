...
Phase 3a review set (charter 2.3a version group):
  ...
  3. Deblock4_Stage_1C_Phase_3a_Designer_Briefing_v1_0.md   (THIS - accumulated 3a clarifications)
```
...
absence of `error:`, not by that marker. W3X releases phases and commits; W3D
