...
**Version:** 1.04
**Date:** 2026-08-16
**Author:** W3C consolidation revision, incorporating W3D review of v1.03 and the W3X/W3D/W3C decision record
**Status:** W3D-ACCEPTED SUCCESSOR DRAFT FOR W3X RATIFICATION. W3D reviewed
v1.03, accepted its consolidation and the W3C-proposed experiment-integrity
corrections, and requested this v1.04 provenance/measurement clarification.
After W3X ratification this document is intended to become the PREVAILING
SINGLE SOURCE OF TRUTH for MPEG-2 deblocking matters in Deblock4. Until that
ratification, v1.02 remains the prevailing document. No new repository or
algorithmic implementation authority is claimed merely by issuing this draft.
...
- `[W3D-ACCEPTED / W3X-PENDING]` - W3D accepted the v1.03 proposal; it becomes
  a project decision only when W3X explicitly ratifies this successor.
...
16. [W3D-ACCEPTED / W3X-PENDING correction to v1.02] The experiment must not
...
## 15.4 Dataset discipline [W3D-ACCEPTED / W3X-PENDING]
...
## 15.5 Decision rule [W3D-ACCEPTED / W3X-PENDING correction]
...
**[W3D-ACCEPTED / W3X-PENDING for explicit ratification into the successor]**
