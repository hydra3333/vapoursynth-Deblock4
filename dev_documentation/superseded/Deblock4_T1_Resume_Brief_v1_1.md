...
## Current document generations - use these, not the ones named lower down

```text
AI_Charter_and_Invariants_Card ................ v1.31
Deblock4_Standing_Task_Register_T_Series ...... v1.11  (DEC-01..DEC-35)
Deblock4_Project_Status ....................... v1.30
T1S00_A_Scope_Manifest ........................ v1.4   (90 terms, FROZEN)
Deblock4_T1_W3C_Review_Scope .................. v1.8
111_New_Chat_Introduction_for_Designer ........ v1.24
111_New_Chat_Introduction_for_Coder ........... v1.32
222-INITIAL_BLURB_FOR_DESIGNER_CHAT ........... v1.2
222-INITIAL_BLURB_FOR_CODER_CHAT .............. v1.2
Deblock4_Session_Bootstrap_Header ............. v1.2
Deblock4_Concise_Project_Summary .............. v1.4
Deblock4_Forward_Roadmap ...................... v1.21 (bannered stale)
Deblock4_Documentation_Currency_Audit ......... v1.5  (bannered stale)
MPEG-2 authority .............................. v1.05 (UNCHANGED - no
...
T1S01a2   currency statements ....... reviewed, REISSUED at v1.1, accepted
                                      shape
T1S01a3   architecture summary ...... ISSUED and REVIEWED. TEN OF TWELVE
                                      ENTRIES NEED CORRECTION. NOT CLOSED.
                                      THIS IS THE FIRST THING TO DO.
T1S01a4   section 23 steps 6-10 ..... not started; carries the DEC-32
                                      ordering defect
...
## OWED ITEM 1 - reissue T1S01a3 as v1.1. Read W3C's response first.

`T1S01a3_B_Coder_Response_v1_0.md` is the input. Its findings, all accepted by
W3X:
...
W3C'S COUNTER-PROPOSAL, WHICH IS BETTER THAN W3D's AND SHOULD BE USED:
    ...
    THIS IS AN I7 CHANGE (a criterion judging W3D's own ledger). W3C has
    already independently verified it. W3X ratifies. IT MUST BE LANDED IN THE
    REVIEW SCOPE (v1.9) BEFORE the T1S01a3 reissue applies it.
...
## OWED ITEM 2 - two live routing records contradict each other (W3C Q5)

```text
Task Register DEC-32 says the section 23 steps 6-10 ordering defect is
deferred to T1S01a3. DEC-35 and Project Status v1.30 say T1S01a4.
DEC-35 is later and more specific and is the correct route. Correct DEC-32
and the Project Status wording at the next natural refresh. W3C explicitly
said NOT to interrupt T1S01a4 for this.
```
...
```text
1. Read W3C's T1S01a3_B response in full. It is the specification for the fix.
2. Land the RETAIN-SUMMARY rule in review scope v1.9 (W3X ratifies first).
3. Reissue T1S01a3 at v1.1 under the corrected rule.
4. Register bump recording all of the above.
5. Then T1S01a4.
```
