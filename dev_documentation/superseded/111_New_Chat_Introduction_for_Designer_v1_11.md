...
**Version:** 1.11
**Date:** 2026-07-31
**Status:** Informative successor orientation; not controlling; aligned to ratified charter v1.21
...
```text
1. AI_Charter_and_Invariants_Card_v1_21.md          CONTROLLING
...
1. The exact current ratified charter and README versions in the repo. This
   file says charter v1.21 / README v1.9; confirm nothing newer has superseded
