...
scope is **Stage 1B.2 - representative code-generation and feature-closure
spikes**: determine the exact SSE4.1 and AVX2 feature closures by compiling and
INSPECTING GENERATED ASSEMBLY, not by assumption, and settle the AVX/SSE
transition question (README section 12.7) by inspection.
...
## 2.2 `Concise_Project_Summary_v1.0.md` - INFORMATIVE

Read for the compact project shape, vocabulary, public surface, stage sequence,
and scalar/SSE4.1/AVX2 relationship.

## 2.3 `AI_Charter_and_Invariants_Card_v1_10.md` - CONTROLLING

This is the W3X-ratified charter baseline, internal version 1.10. Verify the
...
## 2.4 `README_Deblock4_Design_Spec_v1.2.md` - CONTROLLING
...
AI_Charter_and_Invariants_Card_v1_10.md   (or newer ratified)
