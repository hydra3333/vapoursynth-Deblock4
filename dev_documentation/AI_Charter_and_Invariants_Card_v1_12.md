...
**Version:** 1.12
**Date:** 2026-07-29
**Status:** W3X-ratified. Part 1 carries invariants G1-G9. v1.12 reconciles A1/A2 and Part 3.2 to the integer-exact/float-tolerance and named-psABI-tier models, adds the two-core-filter (Classic-first) inventory, and sets the public backend tokens.
**Companion specification:** `README_Deblock4_Design_Spec_v1_5.md`
...
Controlling specification:
    filename          README_Deblock4_Design_Spec_v1_5.md
...
A1  Each filter's canonical ReleaseSafe scalar implementation IS that filter's
    ...
    accuracy differences (e.g. FMA on v3) are a feature, not a defect.
...
x86_64_v2_with_sse41  the full v2 level (SSE3, SSSE3, SSE4.1, SSE4.2, POPCNT).
    The SSE4.1-class backend.

x86_64_v3_with_avx2   the full v3 level (AVX, AVX2, BMI1, BMI2, F16C, FMA,
    LZCNT, MOVBE). The AVX2-class backend. FMA is PART of the level and is NOT
    excluded; .strict (G8) prevents contraction.
```
...
- Companion specification updated to `README_Deblock4_Design_Spec_v1_5.md`,
