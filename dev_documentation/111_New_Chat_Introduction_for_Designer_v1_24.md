# Deblock4 - New Chat Introduction for Designer (v1.24)
...
READ THIS SEQUENCE FIRST AFTER ANY DESIGNER-CHAT RESET:
    ...
    Deblock4_T1_Resume_Brief (latest) - IF T1 IS STILL RUNNING; it is the
        ...
        -> Standing Task Register v1.7 - READ ITS DECISION LOG (section 1)
           IN FULL. DEC-01 to DEC-26, each with a plain-English reason. It is
...
- T1 CONSOLIDATION SWEEP - IN PROGRESS, and it comes before everything below.
  47 documents, frozen 90-term frame, six risk-ordered steps. T1S00 complete;
  T1S01a1 issued and both entries rejected; T1S01a2 held pending the ledger
  template fix
