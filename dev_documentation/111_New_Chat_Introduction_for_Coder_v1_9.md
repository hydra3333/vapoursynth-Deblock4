...
## 2.3 `AI_Charter_and_Invariants_Card_v1_16.md` - CONTROLLING

This is the W3X-ratified charter baseline, internal version 1.16. Verify the
...
ReleaseSafe scalar oracle, completed within-level assembly confirmation, the recorded whole-level runtime requirements, capability detection, or
runtime dispatch.
...
2. Whether the attached charter filename and internal version both identify
   ratified v1.16; stop on any mismatch. (A future successor document is
