...
DERIVED      THE MEASUREMENT SET HAS NO RECORDED METHOD OR DATE. The table
             ...
             which is exactly the kind of detail the LG table lacks. Charter
             P-08 requires claims resting on measurement to record the named
...
DERIVED-BASIS  Charter P-08 ("Claims resting on software source record the
             exact repository, tag or commit, file, and relevant lines" and
             the parallel requirement for standards); section 6.1's
             "317 sampled pictures" versus section 6.2's absence of any
             equivalent; section 3.1's MediaInfo command, which is the
             probable method but is not stated to be the method used.
```
...
ACTION   RETAIN both records in place as canonical. REGISTER an item for W3X:
         ...
         they cannot. W3D recommends this be done BEFORE T6 rather than
         after, because Q14's corpus design cites this table. See covering
         note Q4.
VERDICT  [W3C]
```
