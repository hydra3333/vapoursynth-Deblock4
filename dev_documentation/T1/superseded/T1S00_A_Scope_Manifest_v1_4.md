...
T1S01  THE ARCHITECTURE RECORD - 13 documents, ~5,741 lines, 1,114 hits
       ...
       THIS STEP WAS TOO LARGE AND HAS BEEN SPLIT TWICE, under the
       split-and-report provision reserved here. Both splits are declared,
       neither is a silent truncation:

         T1S01a  the ratified authority document (1,983 lines), carrying
                 PR-1 and PR-2.
         T1S01b  the working record BEHIND it - the six Scopes/ documents
                 and the six GAIS_investigations/ documents (3,758 lines).

       T1S01a is itself delivered in SUB-TRANCHES - T1S01a1, T1S01a2,
       T1S01a3 - each separately reviewable, because a designer session that
       dies mid-document loses everything not yet delivered and sub-tranches
       cap that loss at one part. The designer must identify the FINAL
       sub-tranche of a document as the last, because cross-entry consistency
       within that document is checked there and nowhere earlier.

       STATUS: T1S01a1 issued, covering PR-1 and PR-2 only; W3C rejected both
       entries and found a defect in the ledger template. The template is
       fixed and T1S01a2 follows.
