...
DEC-45  THE TWO-ARTIFACT ORDERING REPAIR IS PROVISIONALLY ADOPTED, SUBJECT TO
        W3C. It is NOT ratified and must not be cited as settled.
        ...
        THE REPAIR: the fault is NOT the order of the two steps. Step 8 names
        ONE artifact where the project needs TWO.
        ...
        on a distinction the ratified text does not draw - that the
        comparison instruments and the accepted oracle are different
        artifacts. If W3C refutes the distinction, the provisional adoption
        falls and the defect needs a different answer.
