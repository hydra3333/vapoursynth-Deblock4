...
# 0a. STATE ADVANCE (v1.4) - WHAT IS OWED RIGHT NOW
...
T1S01a2   currency statements ....... reviewed, REISSUED at v1.1. W3C
                                      ...
                                      entries; those reconcile at a5 (DEC-39)
T1S01a3   architecture summary ...... CLOSED at ledger v1.4, provisionally,
                                      ...
                                      is provisional - a5's consistency pass
...
T1S01a5   Appendix E + final pass .... NOT STARTED. THIS IS THE NEXT WORK,
                                      and it is the FINAL sub-tranche of
                                      this document. SIX items are owed to
                                      it by name - see below
...
## SIX THINGS ARE OWED TO T1S01a5 BY NAME
...
## The two rules ratified since v1.2 of this brief, which bind a4 onward
...
3. T1S01a5: Appendix E, and the FINAL sub-tranche of this document - the
   ...
   earlier. THREE THINGS ARE OWED TO IT BY NAME: LED-023's deferred blanket
   provenance claim; T1S01a2's old-format duplicate entries (DEC-39); and
   LED-020/LED-021's exhaustive-sounding copy lists (DEC-43).
