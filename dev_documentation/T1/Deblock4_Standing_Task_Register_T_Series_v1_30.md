...
recovery-state reconciliation after W3D session limit
...
```text
  T1        Formal consolidation sweep ......... IN PROGRESS.
            ...
            T1S00  COMPLETE as the frozen historical survey/search frame.
                    v1.5 DELIVERY-DESCRIBING-ONLY bump is authorised by
                    DEC-69, but is not the next act while a5 recovery closure
                    is still outstanding.

            T1S01a1 CLOSED by decision.
            T1S01a2 CLOSED; reissued v1.1.
            T1S01a3 CLOSED provisionally; final a7 consistency pass may reopen.
            T1S01a4 CLOSED provisionally; final a7 consistency pass may reopen.

            T1S01a5 AUTHORITY SECTIONS 1-8, lines 223-715:
                    CLASSIFICATION REPAIR v1.1 COMPLETE FROM W3D'S SIDE.
                    The preceding W3C review gave the repair substance a PASS
                    and requested only three mechanical fixes; v1.1 visibly
                    contains those exact fixes.

                    AFTER THE OLD W3D SESSION DIED, W3C reconstructed the
                    promised ledger rewrite as:
                        T1S01a5_A_Ledger_Body_Part1_v1_4.md
                    from the physically delivered ledger v1.3 +
                    Classification Repair v1.1 + W3D-accepted W3C findings.

                    IMPORTANT: that v1.4 is a RECOVERY CANDIDATE authored by
                    W3C. It is NOT a normal W3D proposal already independently
                    reviewed by W3C. It contains 39 atomic entries and is the
                    artifact successor W3D must verify/adopt/correct.

                    a5 IS NOT CLOSED YET.
                    NO NEW SEARCH OR CLASSIFICATION ROUND IS INDICATED.

            T1S01a5b AUTHORITY SECTIONS 9-13, lines 716-1098:
                    NOT STARTED.
                    The split is RATIFIED at DEC-68.
                    DO NOT START until a5's recovery ledger has been
                    independently checked by successor W3D and W3X has
                    explicitly closed the recovery-review path.

            T1S01a6 sections 14-22 plus section 24 and Appendices A-D:
                    NOT STARTED.

            T1S01a7 Appendix E older entries, six owed items and final
                    whole-document consistency pass:
                    NOT STARTED; DECLARED FINAL a-tranche.

  T1S01b   Working record behind authority ...... NOT STARTED; SCOPES-ONLY
                                                 under DEC-66.

  T1-EVID  Outgoing-designer answer set ......... COMMITTED as evidence
                                                 (DEC-11).
  T1-PREREG Pre-registered items ................ 4 registered; see section.
  T1.1      Mathematical inventory/gap table ... NEW; runs inside T1,
                                                 reports after it.

  T2        Retire Grid Knowledge ............... BLOCKED by T1.
  T3        De-duplicate into references ........ BLOCKED by T1.
  T4        Boundary-set mathematics ............ SUBSUMED into T1.1-MATHS.
  T8        Close provenance gaps T1 finds ...... OPEN; runs AFTER T1 and
                                                 BEFORE T5; does not block
                                                 T1/T2/T3.
  T5        Detector mathematics ................ AFTER T1 AND T8.
  T6        D4-Q14 experiment plan .............. AFTER T5, separately
                                                 ratified.
  ...
  CURRENT POPULATIONS - DO NOT CONFLATE:
      frozen T1S00 survey record ................. 47 documents surveyed
  ...
  CURRENT RESUME ORDER FOR A SUCCESSOR W3D:
      ...
      -> this register, section 0a recovery gate and DECISION LOG
      -> physically delivered a5 ledger v1.3
      -> T1S01a5_A_Classification_Repair_v1_1.md
      -> W3C recovery reconstruction ledger v1.4
      -> independently verify/adopt/correct that recovery ledger
