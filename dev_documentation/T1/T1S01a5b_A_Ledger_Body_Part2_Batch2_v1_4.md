...
**Date:** 2026-08-23
**Author:** W3D
**Status:** ADJUDICATION LEDGER, BATCH 2, SECOND CORRECTION GENERATION per
W3C correction review 1 (3 AGREE / 9 DISAGREE, findings F29-F37). W3D
verified every finding at exact lines and ACCEPTED ALL NINE; none was
contested. NO disposition, tier or substantive outcome was challenged in
this round - W3C endorsed the LED-091a overturn, the LED-092 split and the
ERRONEOUS classification. The round was entirely about CORRECTION HYGIENE:
stale fields left contradicting the fields beside them, occurrences added
to one entry but not its neighbour, and a propagation record whose result
was probably right but was not PROVEN to the ratified method.
The first correction generation (v1.3) implemented F18-F28 per W3C review
T1S01a5b_B Batch2 v1 (10 AGREE / 11 DISAGREE); all eleven were verified
and accepted then, as all nine are now. Covers the FULL BATCH-2 RANGE,
...
LED-082   (split under the atomic-claim rule; map pre-flagged this
  ...
  PROPOSED
  ACTION       None.
  VERDICT      AGREE (T1S01a5b_B Batch2 correction 1, 2026-08-23)
...
LED-082a
  ...
  SWEPT        Population: 38 files. Probe family: {"experiment
               ...
               experiment/candidate"}. SEVEN loci in three files (count
               corrected at v1.4 per F29: v1.3 said six and did not
               re-derive after F19 added the D4-Q05 occurrence; the
               enumeration below is, and was, correct), every one
  ...
  PROPOSED
  ACTION       None.
  VERDICT      (W3C - correction review 2)
...
LED-083
  ...
  SWEPT        Population: 38 files. Probe family: {"exact for
               ...
               risk); Evaluation 1041-1042 (CARRIER - ADDED AT v1.4 per
               F30: "D's measured false internal activation / frame-frame
               approximation cost", the approximation limb stated as a
               measured quantity); authority 1224-1225 (CARRIER, OUTSIDE
               RANGE - ADDED AT v1.4 per F30, carried below). The section
               0 item 12 copy was found via the family's approximation
               limb and is classified in REASON.
               ...
               the same way. THE v1.4 ADDITIONS ARE THE SAME DEFECT ONE
               LEVEL DOWN: v1.3 added Evaluation 117-119 here but not at
               LED-084, and authority 1224-1225 at LED-084 but not here,
               although each passage carries both entries' limbs. Both
               entries now carry both.
  CITED-OUTSIDE-RANGE
               location: section 15 measurement requirements, lines
               1224-1225
               proposition: D's pitch-2 treatment versus exact pitch-1 at
               FRAME/FRAME boundaries must be measured
               evidence use here: duplication of the approximation limb
               (added at v1.4 per F30)
               owning tranche: T1S01a6
  TIER         C
  PROPOSED
  ACTION       None.
...
LED-084
  ...
  SWEPT        Population: 38 files. Probe family: {"no classifier
               ...
               using"}. Every locus opened at its exact lines:
                 ...
                 Re-Decision Evaluation: 117-119 (CARRIER of RISK 2 -
                   ADDED AT v1.4 per F31: D processes a FRAME/FRAME
                   macroblock-row boundary in the pitch-2 conservative
                   form rather than the exact pitch-1 form, matching this
                   entry's own "pitch-2 rather than" probe wording. v1.3
                   used this very passage at LED-083 and failed to carry
                   it here - the same cross-entry consistency defect F30
                   records from the other side); 670 and 1041-1043
                   (CARRIER - ADDED AT v1.3 per F21: both state the
                   frame/frame approximation and false-internal-
                   activation costs);
...
LED-091a
  ...
  SWEPT        Population: 38 files. Probe families: {"proof of safety",
               ...
               classified per REASON - SEVEN of them DIFFERENT and ONE,
               Evaluation 595-607, a CARRIER (corrected at v1.4 per F32:
               v1.3's overturn rewrote REASON but left this field saying
               all eight were DIFFERENT, contradicting the entry beside
               it - the scope-0.7 entry-sweep failure mode); and the
               full
  ...
  CITED-OUTSIDE-RANGE
               ...
               not-a-safety-proof finding is homed at section 12.5 and is
               CURRENT-DUPLICATE, carried by Re-Decision Evaluation
               595-607 (corrected at v1.4 per F32: v1.3 left this
               instruction saying CURRENT-UNIQUE after the overturn).
...
LED-091b
  ...
  DISPOSITION  CURRENT-DUPLICATE
  DUPLICATE-ACTION  STAY-CANONICAL
  REASON       True and duplicated. SPLIT RATIONALE RESTATED AT v1.4 per
               F33: v1.3 still justified the split by saying this limb
               "has carriers, its neighbour has none". After F23 that is
               FALSE - LED-091a has the Evaluation 595-607 carrier. The
               split nonetheless stands on its own ground, which is what
               it should have said from the outset: the two limbs are
               DISTINCT PROPOSITIONS with DIFFERENT CARRIER SETS. This
               limb (not soft confidence; normal correction strength
               after activation) is carried by the Evaluation's
               binary-decision passages, the README and Appendix C; its
               neighbour (not a proof of safety) is carried by the
               Evaluation's tuning-limit passage alone. Neither set
               proves the other. Canonical home: section
...
LED-092   (SPLIT AT v1.3 per F25, on W3X's ruling. The source sentence
  ...
  REASON       True as narrowed. The RETENTION limb is sound: the five
               ...
               the retained rules as ratified architecture, and the
               eventual de-duplication of any README copies is T3's work,
               not this ledger's. PROVENANCE IS DELIBERATELY NOT STATED
               HERE (corrected at v1.4 per F34: v1.3 said "the README
               remains their historical ORIGIN", which contradicts
               LED-092a inside the same correction generation - README
               origin holds for 13.2-13.4 only). Provenance belongs
               entirely to LED-092a; this entry states RETENTION and
               nothing else. Classified out: the fourteen further
...
LED-092a   (new at v1.3 per F25, on W3X's ruling: the provenance limb of
  ...
  PROPAGATION  (DEC-84, Review Scope 0.11 - MANDATORY. REWRITTEN AT v1.4
               per F35, structured explicitly against the ratified six
               steps. W3C did not challenge the RESULT; it challenged
               whether v1.3's record PROVED it. It did not: v1.3 declared
               no scope inside the block, stated no method, jumped
               straight to four opened candidates without showing they
               exhausted anything, and silently omitted a
               README-provenance-adjacent passage. That objection is
               correct and this rewrite answers it. Scope 0.11 is cited,
               not paraphrased.)

               STEP 1 - DECLARE THE PROPAGATION SCOPE / POPULATION.
                 The bounded set in which reliance on "the section-13
                 rules are older README rules" could MATERIALLY SURVIVE
                 in CURRENT work: the 38 files of Population Delta v1.1.
                 Nothing outside it is claimed. No source, mathematics,
                 tests or build objects exist that could rely on this
                 proposition - no D4 kernel exists, and provenance of a
                 documentation rule set has no code consequence. Scope
                 0.11's closing sentence applies: this is about
                 potentially affected CURRENT work, not an archaeological
                 search for every historical mention.

               STEP 2 - SEARCH FOR RELIANCE ON THE PROPOSITION, NOT
               MERELY ITS WORDING, using the method appropriate to it.
                 The proposition is a PROVENANCE claim, so reliance means
                 a current document treating the section-13 rules AS
                 README-DERIVED, or deriving anything from that
                 derivation. Wording search alone is insufficient - a
                 dependent could rely without repeating the phrase.
                 Method: (a) a lexical family over the 38 files -
                 {"older README rules", "README rules", "retain the
                 following", "rules retained", "from the README",
                 "README-origin", "README provenance"} - to locate
                 candidates; (b) a SEMANTIC pass over every current
                 document that discusses section 13 or the README's
                 analyser-discipline cluster, opening each at its exact
                 lines and asking whether its statement DEPENDS on
                 section 13's provenance claim or stands on independent
                 evidence.

               STEP 3 - ENUMERATE AND CLASSIFY CANDIDATE DEPENDENCIES,
               with attackable location and basis. Five candidates; every
               one opened at its exact lines:
                 (i) designer introduction, lines 647-649. Quotes "among
                     rules retained because they are 'still exactly
                     right'". NON-RELIANCE: it cites the RETENTION limb
                     and makes no provenance claim.
                 (ii) Project Status, lines 458-461. The PR-1 record,
                     same retention phrase. NON-RELIANCE: same basis.
                 (iii) authority line 228. Says THIS DOCUMENT exists so a
                     successor need not reconstruct state "from the
                     README, old grid notes, GAIS captures and chat
                     history". NON-RELIANCE: a claim about this
                     document's purpose, not about section 13's rules.
                 (iv) Re-Decision Brief line 66. Quotes the README for
                     the step-4 rationale. NON-RELIANCE: unrelated
                     subject.
                 (v) Re-Decision Evaluation, section A5, lines 858-875.
                     ADDED AT v1.4 per F35 - v1.3 omitted it, although
                     LED-092 itself cites it. It states that README lines
                     976-1017 "already states" the analyser-discipline
                     cluster and lists its five bullets.
                     NON-RELIANCE, and the classification matters: A5 is
                     INDEPENDENT PRIOR EVIDENCE, derived by W3C reading
                     the README directly and predating the authority's
                     section 13. It is what the false claim
                     OVER-GENERALISED FROM, not something that relies on
                     it - and it is accurate: it asserts README origin
                     only for the analyser cluster (13.2-13.4), which is
                     exactly the true part. The direction of dependence
                     runs the other way.

               STEP 4 - ROUTE EACH ACTUAL DEPENDENCY.
                 No actual dependency was found, so no routing is
                 required. Had A5 been a dependency it would have routed
                 to "remains valid for an independent reason"; it does
                 not reach routing because it is not a dependent.

               STEP 5 - NONE FOUND, RECORDED WITH SCOPE AND METHOD.
                 NONE FOUND, within the scope of step 1 and by the method
                 of step 2. The error is confined to authority line 1052.

               STEP 6 - NO EXHAUSTIVENESS BEYOND DECLARED SCOPE/METHOD.
                 This record claims nothing outside the 38-file
                 population, and nothing that the lexical-plus-semantic
                 method of step 2 could not reach. A reliance expressed
                 in vocabulary the lexical family misses AND in a
                 document the semantic pass did not treat as
                 section-13-related would not have been found. That
                 residual risk is stated, not concealed.

               CONTRAST WORTH RECORDING: LED-081a's false pointer had
               FOUR dependents. This one has none, because every
               downstream repetition happened to quote the true limb.
               A nil result is the convenient outcome and was therefore
               the one to prove hardest - W3D's v1.3 record did not, and
               W3C was right to refuse it.
...
LED-094
  ...
  REASON       True and duplicated. Canonical home: 13.2. Known
               ...
               implementation/configuration uses; that was wrong.
               ADDED AT v1.4 per F36: the SAME document's line 731 -
               "scheduler/kernel separation; detector is an
               unmodified-source pre-pass" - is a further direct CARRIER
               of the pre-pass limb, found by this entry's own "pre-pass"
               family and left unclassified by v1.3.
               CITATION CORRECTED AT v1.4 per F36: v1.3 asserted the line
               "survives unchanged in designer introduction v1.34". THAT
               ASSERTION IS WITHDRAWN. The declared population is
               Population Delta v1.1, which contains designer
               introduction v1.33; v1.34 is neither declared nor supplied
               to the reviewer, and an entry may not rest on a generation
               outside the declared population (DEC-50, DEC-77). All
               citations here are to v1.33 as declared. W3X ruled at v1.4
               that the population stays as declared for the remainder of
               this batch.
...
LED-095
  ...
  REASON       True and duplicated. Canonical home: 13.3. Known
               ...
               ADDED AT v1.4 per F37, both in the same declared v1.33
               document and both CARRIER: line 801 - "hidden cross-frame
               detector hysteresis under fmParallel", listed under
               REJECTED / DO NOT RESURRECT, which states this entry's
               forbidden-state limb in prohibition form and is reached by
               this entry's own "cross-frame"/"fmParallel" family; and
               line 850 - "no hidden temporal state" in the
               current-architecture checklist, a direct reformulation of
               the central proposition. v1.3 classified neither.
...
ENTRIES IN THIS VERSION: 22
    ...
    LED-091a CURRENT-DUPLICATE  STAY-CANONICAL   C   repaired (F32)
    LED-091b CURRENT-DUPLICATE  STAY-CANONICAL   C   repaired (F33)
    LED-092  CURRENT-DUPLICATE  STAY-CANONICAL   C   repaired (F34)
    LED-092a SUPERSEDED (ERRONEOUS)  n/a         A   propagation
                                                     rewritten (F35)
...
WHAT CORRECTION REVIEW 1 CHANGED (v1.4): NOTHING SUBSTANTIVE. Every
disposition, tier and outcome from v1.3 survived - W3C endorsed the
overturn, the split and the ERRONEOUS classification. All nine findings
concerned CORRECTION HYGIENE, and they fall in three groups:
  - THREE ENTRY-SWEEP FAILURES (F32, F33, F34): v1.3 rewrote a field and
    left the field beside it asserting the opposite. LED-091a's SWEPT
    still called every hit DIFFERENT and its a6 instruction still said
    CURRENT-UNIQUE; LED-091b still justified its split by its
    neighbour having no carriers; LED-092 still asserted README origin
    for rules LED-092a had just proved were not. Scope 0.7 names this
    failure mode, and one correction generation produced three of it.
  - THREE CROSS-ENTRY CONSISTENCY MISSES (F29, F30, F31): a stale
    derived count after adding an occurrence, and two passages added to
    one entry but not to the neighbour they equally carry.
  - THREE EVIDENCE/CITATION DEFECTS (F35, F36, F37): a propagation
    record whose nil result was probably right but was not PROVEN to
    DEC-84's six steps; two further carriers in a document already
    cited; and a citation to designer introduction v1.34, a generation
...
DEC-84 PROPAGATION RESULT (LED-092a): NONE FOUND, within a declared
scope and by a stated method, per the six-step record rewritten at v1.4.
FIVE candidates enumerated and classified, all NON-RELIANCE - the fifth,
the Re-Decision Evaluation's A5 section, is independent prior evidence
that the false claim over-generalised FROM, not a dependent of it. The
error is confined to authority line 1052 - unlike LED-081a, whose false
pointer had four dependents.

REVIEW STATE AT v1.4: 13 entries carry recorded AGREE verdicts - 10 from
T1S01a5b_B Batch2 v1 and 3 from correction review 1 (LED-082, LED-085,
LED-096) - and are NOT reopened. NINE items are open for correction
review 2.
...
```text
v1.4 (2026-08-23) SECOND CORRECTION GENERATION per W3C correction review 1
     (3 AGREE / 9 DISAGREE, F29-F37). W3D verified every finding at exact
     lines and accepted all nine; none contested. NOTHING SUBSTANTIVE
     CHANGED - no disposition, tier or outcome was challenged, and W3C
     endorsed the LED-091a overturn, the LED-092 split and the ERRONEOUS
     classification. Repairs: three entry-sweep staleness defects where
     v1.3 rewrote a field and left its neighbour contradicting it (F32
     LED-091a's SWEPT and its a6 instruction; F33 LED-091b's split
     rationale, restated on the ground it should always have used - two
     distinct propositions with different carrier sets; F34 LED-092's
     surviving README-origin sentence, with provenance now left entirely
     to LED-092a); three cross-entry consistency misses (F29 LED-082a's
     stale derived count; F30 and F31, the same two passages now carried
     by both LED-083 and LED-084 instead of one each); and three
     evidence/citation defects (F35, LED-092a's PROPAGATION rewritten
     explicitly against DEC-84's six ratified steps with a declared
     scope, a stated lexical-plus-semantic method, FIVE candidates
     including the previously omitted Evaluation A5 section classified
     NON-RELIANCE, and an explicit residual-risk statement - the nil
     result is unchanged but is now proven rather than asserted; F36,
     designer introduction line 731 added and the citation to
     introduction v1.34 WITHDRAWN because that generation is outside the
     declared population, W3X having ruled the population stays as
     declared for this batch; F37, introduction lines 801 and 850 added).
     Entry count unchanged at 22. Thirteen AGREE verdicts recorded.
