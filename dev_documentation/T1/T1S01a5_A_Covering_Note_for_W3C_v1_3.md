...
**Author:** W3D
**Route:** W3D -> W3X -> W3C
**Accompanies:** `T1S01a5_A_Ledger_Body_Part1` and `T1S01a5_A_Corpus_Manifest`, HIGHEST COMMITTED VERSION of each. Version numbers are deliberately not pinned here - a pinned companion reference in a covering note is a scheduled defect, and one staled in this batch already.
...
# 0b. WHAT CHANGED AT v1.3 - TWO METHOD DEFECTS, BOTH W3C's, NEITHER
# CHANGING A FINDING

```text
W3C raised both while still enumerating, before delivering a formal response.
W3D verified both cold rather than conceding them, and both hold.

DEFECT 1 - COMPOUND DISPOSITIONS. Three entries gave different dispositions
to different propositions inside one entry. DEC-33(a) allows exactly two
remedies - SPLIT or NARROW - and a compound field is neither.
  THE EXTENT IS THREE, ENUMERATED NOT SAMPLED. Every DISPOSITION field in the
  ledger was extracted and inspected: LED-051, LED-052, LED-053. W3C said it
  was enumerating rather than reporting the first example; the answer is
  three, and it is now in the ledger so the enumeration need not be repeated.
  SPLIT INTO LED-051a, LED-052a and LED-053a. No disposition, canonical home,
  duplicate action or SWEPT result changed. Entry count 31 -> 34.
  ONE BOUNDARY WORTH FIXING, because it decides whether ten further entries
  are also defective: an entry with ONE disposition and PER-PROPOSITION
  canonical homes or actions is EXPRESSLY REQUIRED by review scope 5.4
  ("identify the canonical source PER PROPOSITION") and ratified at DEC-36.
  Per-proposition DISPOSITIONS are what is forbidden. The ten entries doing
  the former are correct as written and are NOT touched.

DEFECT 2 - THE STAY-CANONICAL FIRST-USE CLAIM WAS FALSE, and this is the one
worth reading.
  LED-036 said it was the first entry in T1 to claim STAY-CANONICAL. It is
  not: T1S01a3 ledger v1.4 claims it at LED-020 (line 535) and LED-021
  (line 654). Verified cold in the a3 ledger.
  THE SUBSTANTIVE RESULT SURVIVES INTACT - canonical home, named copy,
  DEC-43 evidence requirement all stand. Only the framing is withdrawn.
  WHAT MAKES IT WORTH A DECISION ENTRY rather than a quiet fix: the claim was
  inherited from the resume brief, repeated, AND THE BRIEF WAS CITED AS ITS
  DERIVED-BASIS. An unchecked statement acquired a source and therefore
  looked evidenced. That is a worse failure than a bare assertion, because a
  cited basis survives the reader's first test.
  IT IS ALSO INSTANCE 8 IN MIRROR IMAGE. Instance 8 was a sweep that produced
  a find without opening the ledgers. This was a claim ABOUT the ledgers made
  without opening them - and the founding T1 incident was a classification
  believed instead of checked. Recorded at DEC-41 as instance eleven.
  FIXED AT SOURCE: resume brief v1.7 corrects the line, so the next successor
  does not inherit it a third time.

W3D'S ASSESSMENT OF THE ROUND: three findings now, none of them about a
disposition being wrong, all of them about method or provenance - and all
made before the reviewer read the entries it was sent to review.
```

---

# 0a. WHAT CHANGED AT v1.2 - THE SEARCH POPULATION WAS WRONG BY 37 FILES

```text
W3C, on receiving the refreshed corpus and BEFORE completing a single entry
review, noticed that the corpus manifest's file table contradicted the
manifest's own prose: the prose said retired trees were excluded, and the
table listed 37 files under T1/superseded/.

IT WAS RIGHT. The manifest reported a 124-file search population. The a5
searches actually ran over 87.

WHY THE TWO DIVERGED: the ledger's searches excluded any path containing
"/superseded/", while the manifest generator excluded four literal folder
prefixes copied from T1S00 section 2 - a list written before T1/superseded/
existed. Two implementations of one rule, never checked against each other.
That is the fault charter G3 forbids in the dispatch mechanism, rebuilt in an
evidence artifact.

W3X RULED THE RULE ANEW (register DEC-60): exclude any file whose path
contains a folder whose NAME BEGINS "superseded" or "scheduled_for_deletion".
A mechanical test, not a list to maintain. 519 files, 432 excluded, 87
searched. The adjudication population was re-derived rather than assumed and
is UNCHANGED at 47.

WHAT THIS DOES AND DOES NOT DO TO THE LEDGER.
  THE SEARCHES WERE NEVER WRONG. Every SWEPT result was produced over the 87.
  NO FINDING, DISPOSITION, ACTION OR VERDICT CHANGES.
  WHAT WAS WRONG was the DESCRIPTION of the population, in the artifact
  supplied so W3C could reproduce the searches - which is the worse half to
  get wrong, because it is the half a reviewer checks against.

  THE FIX IS A MECHANISM, NOT THIRTY-NINE CORRECTIONS. Ledger section 0.5 now
  defines the population ONCE and all 39 SWEPT fields inherit it. LED-033 was
  the only entry that enumerated the exclusions rather than referring to
  them, and it now refers to 0.5.

W3D ALSO TESTED WHETHER THE AMBIGUITY COULD HAVE CHANGED A RESULT, before
W3X ruled, rather than waiting to find out: no CURRENT-UNIQUE claim in this
ledger returns any hit in a retired tree. Had the ruling gone the other way,
LED-037's Schedule-collision enumeration would have needed re-cutting; it did
not, and it stands.

W3D'S ASSESSMENT: this is the second finding W3C has made in this
sub-tranche without reviewing an entry, and it is the more valuable one - it
was a defect in the evidence supply rather than in the reasoning, which is
the class a reviewer is least expected to catch and most damaged by.
```
...
```text
  LED-033   v1.2=768c3f3aaaa77f04 v1.3=768c3f3aaaa77f04  identical
  LED-034   v1.2=40559070f369de4f v1.3=40559070f369de4f  identical
  LED-035   v1.2=d26ef9b9329bf5b8 v1.3=d26ef9b9329bf5b8  identical
  LED-036   v1.2=2f6cb2da3e157344 v1.3=2a24b3f2b1862bc3  CHANGED
  LED-037   v1.2=443c56304a242716 v1.3=443c56304a242716  identical
  LED-038   v1.2=e94c7f2444adb7fc v1.3=e94c7f2444adb7fc  identical
  LED-039   v1.2=c1934ffce71c251d v1.3=c1934ffce71c251d  identical
  LED-040   v1.2=175c445fbfadfcf9 v1.3=175c445fbfadfcf9  identical
  LED-041   v1.2=35d82ecac5353236 v1.3=35d82ecac5353236  identical
  LED-042   v1.2=8c2d6d86e181732b v1.3=8c2d6d86e181732b  identical
  LED-043   v1.2=41ed9747ef505928 v1.3=41ed9747ef505928  identical
  LED-044   v1.2=bd9f1145e3ac06d2 v1.3=bd9f1145e3ac06d2  identical
  LED-045   v1.2=b34c81fe7f6e4458 v1.3=b34c81fe7f6e4458  identical
  LED-046   v1.2=e788d7c7313e4b44 v1.3=e788d7c7313e4b44  identical
  LED-047   v1.2=0938526727fb9930 v1.3=0938526727fb9930  identical
  LED-048   v1.2=6b6d485a8d8772fd v1.3=6b6d485a8d8772fd  identical
  LED-049   v1.2=5203554647fa4ecc v1.3=5203554647fa4ecc  identical
  LED-050   v1.2=457b4df22b3ba738 v1.3=457b4df22b3ba738  identical
  LED-051   v1.2=7fbc42ee86ef8bdb v1.3=b2cdc3b13a24a1e1  CHANGED
  LED-051a  v1.2=-- new at v1.3 -- v1.3=9005c57c96226272  NEW
  LED-052   v1.2=92892b8b6f09b99f v1.3=31932b3324b82c31  CHANGED
  LED-052a  v1.2=-- new at v1.3 -- v1.3=8d36049f8e5b3971  NEW
  LED-053   v1.2=b59ccc40f4281304 v1.3=d5e440f890187cb0  CHANGED
  LED-053a  v1.2=-- new at v1.3 -- v1.3=79245d1bf81adddd  NEW
  LED-054   v1.2=bf200fbcecd4fa89 v1.3=bf200fbcecd4fa89  identical
  LED-055   v1.2=c05d94e69b5241c8 v1.3=c05d94e69b5241c8  identical
  LED-056   v1.2=dcf9bc45a50749a9 v1.3=dcf9bc45a50749a9  identical
  LED-057   v1.2=42f7f5d60902933e v1.3=42f7f5d60902933e  identical
  LED-058   v1.2=52142291a7f2bf3e v1.3=52142291a7f2bf3e  identical
  LED-059   v1.2=8d29b0c7020a6354 v1.3=8d29b0c7020a6354  identical
  LED-060   v1.2=3e4a1aed391ee018 v1.3=3e4a1aed391ee018  identical
  LED-061   v1.2=711838c9a9681932 v1.3=711838c9a9681932  identical
  LED-062   v1.2=fbb09efb68a83c45 v1.3=fbb09efb68a83c45  identical
  LED-063   v1.2=18ca9ef9f0c177f1 v1.3=091ca4204bf5ae30  CHANGED

RESULT: 31 entries at v1.2 -> 34 at v1.3.
    NEW      LED-051a, LED-052a, LED-053a, from the DEC-33(a) splits.
    CHANGED  LED-036 (first-use framing withdrawn) and LED-051, LED-052,
             LED-053 (narrowed by their splits).
    IDENTICAL  the remaining 26.
    LED-063 SHOWS AS CHANGED IN THE TABLE AND ITS ENTRY IS NOT. The digest
    method splits the file on entry headings, so the closing-questions
    section - where Q-C's first-use framing was withdrawn - falls inside the
    final block. LED-063's entry body alone hashes identically across v1.2
    and v1.3 (d7d94d3bf9ab710a, 4216 bytes both). Checked rather than
    explained away.
  W3C may confine any re-read to LED-036, LED-051, LED-051a, LED-052,
  LED-052a, LED-053, LED-053a and closing question Q-C.
```
