...
**Version:** 1.5 - post-repair rewrite. Built TEXTUALLY on delivered ledger v1.3 with only the deltas mandated by Classification Repair v1.1, W3C review response v1.0, and ratified register decisions. 39 entries.
**Date:** 2026-08-19
...
**Supersedes:** ledger v1.3 (delivered W3D artifact, the textual basis of this document)
...
THE DELIVERED ARTIFACTS USED:
    ...
    T1S01a5_B_Coder_Response_v1_1.md             W3C - entry review
    T1S01a5_B_ReSweep_CrossCheck_Response_v1_0   W3C - cross-check
...
N1  LED-046's cross-reference may be stale.
    The recovery reconstruction changed LED-046's reference from LED-049 to
    LED-052a. NO DELIVERED ARTIFACT MANDATES THIS. It appears only in W3C's
    resume brief and W3C's reconstruction. BASIS FOR SAYING SO, per DEC-50:
    a whole-text search of Classification Repair v1.1 and of W3C's 532-line
    response for "LED-046" and "LED-052a" - the repair mentions LED-046 only
    as a probe-table heading and LED-052a only in its section 3 findings
    list; W3C's response mentions LED-046 twice, neither about a
    cross-reference. THE CHANGE IS THEREFORE NOT APPLIED HERE. Whether
    v1.3's LED-049 reference is correct is a live question and is put to
    W3C in Q-J below.
...
Q-J  A CHANGE W3D DECLINED TO MAKE, AND WANTS ATTACKED. The recovery
     reconstruction changed LED-046's cross-reference from LED-049 to
     LED-052a. NO DELIVERED ARTIFACT MANDATES THAT - see 0.4g N1 for the
     search basis. It is therefore NOT APPLIED here and v1.3's reference
     stands. QUESTION: is v1.3's LED-049 reference correct as it stands, or
     is the reconstruction right that it should point at LED-052a? W3D has no
     position and is asking rather than choosing.
...
*End of T1S01a5 ledger v1.5. Nothing here is ratified. Every PROPOSED ACTION
