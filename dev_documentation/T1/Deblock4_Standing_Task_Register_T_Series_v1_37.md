...
```text
T1S00   Manifest, frozen search frame            COMPLETE; at v1.9
                                               (R7: pointer corrected v1.36)
...
T1S01   THE ARCHITECTURE RECORD
  ...
  T1S01a  The ratified MPEG-2 authority (1,983 lines)
    ...
    a5    BODY PART 1, sections 1-8,
          lines 223-715                        CLOSED 2026-08-21, DEC-85/88.
                                                 Final ledger v1.10: 44
                                                 entries, all Tier C - 16
                                                 CURRENT-UNIQUE, 28
                                                 CURRENT-DUPLICATE, zero
                                                 CONFLICTING/SUPERSEDED/
                                                 OPERATIVE-SPEC - all
                                                 independently reproduced by
                                                 W3C. Residue R1-R8 carried
                                                 forward; see section 0c.
                                                 NOTHING IN a5 IS RATIFIED
                                                 INTO ANY AUTHORITY: every
                                                 PROPOSED ACTION remains a
                                                 proposal awaiting T3.
...
DOWNSTREAM OF T1, IN ORDER:
  ...
  T9      External Basis Revalidation (EBR)      REGISTERED 2026-08-22,
          gate                                   W3X ruling.
          Runs AFTER T1 completes IN FULL. BLOCKS T3 ratification and any
          T6/Q14 or kernel scope. Terminal cross-check that B2's EXTERNAL
          evidence has not been invalidated or superseded since verification.
          T1 proves the corpus is internally consistent. It cannot prove the
          foundations. T9 is where that happens.
...
## 0c. T1S01a5 RESIDUE REGISTER - CARRIED FORWARD UNDER DEC-85

```text
a5 CLOSED WITH KNOWN RESIDUE, DELIBERATELY AND ON THE RECORD. This section
exists so the residue is a TRACKED OBLIGATION rather than an undiscovered
defect. W3C's FINAL verification (response v1.4) enumerated it; W3D disputes
none of it.

DO NOT CREATE AN a5 CORRECTION GENERATION FOR ANY ITEM BELOW. DEC-85 forbids
it; DEC-88 records the closure. These are a7 and continuity-refresh work.

ROUTED TO T1S01a7's WHOLE-DOCUMENT CONSISTENCY PASS:
  R1  LED-047's SWEPT still OPENS with audit-result framing although LED-047a
      now owns that disposition. Later prose in the same field is correct.
      Reframe the opening. NO new evidence or probe required.
  R2  Q-H enumerates eleven suffix entries INCLUDING LED-055a and LED-055b,
      then still asks "whether LED-051 and LED-055 really need none".
      LED-055 plainly has two. Remove or narrow the obsolete limb.
  R3  Q-K's historical parenthesis ends mid-sentence. Editorial.
  R4  Ledger header date says 2026-08-19 while the revision history says
      v1.10 (2026-08-20). Metadata only.
  R5  Section 0.4h says "three times ... twice the document was wrong and
      twice the GATE was wrong". TWO PLUS TWO IS FOUR, and 0.4d's 26-vs-28
      failure makes the history longer still. THE PARAGRAPH TEACHING THAT
      REMEMBERED TOTALS ARE UNRELIABLE NARRATES A REMEMBERED TOTAL. Fix by
      ENUMERATING the incidents and DERIVING the count.
  R6  LED-063 retains "Establishing that requires reading it against the
      F4/F5 provenance claims, which is T1S01a6's work" after check (6) has
      already done exactly that. Old deferral logic beside a completed check.
      The live ACTION is correct and unaffected.

ROUTED TO THE BOUNDED POST-a5 CONTINUITY REFRESH:
  R7  This register's own T1S00 pointer had staled to v1.7 against a supplied
      v1.9. CORRECTED AT v1.36; recorded because the class recurs and 0b
      warns about exactly it.

HISTORICAL RECORD ONLY:
  R8  Covering note v1.9 said v1.10 applied items A-P "in full". R1-R6 show
      it was not literally in full. No replacement note is warranted under
      DEC-85. W3C RESPONSE v1.4 IS THE AUTHORITATIVE RECORD of what passed
      and what remains - not the covering note.

WHAT W3C EXPLICITLY DECLINED TO CARRY, so the a7 list stays bounded and no
successor reopens settled work: LED-037a uniqueness; LED-043 occurrence
handling; LED-053d's Appendix-A treatment; LED-055a's CURRENT-DUPLICATE and
four-candidate classification; LED-055b; LED-059's section-15 correction and
current ACTION; LED-061; LED-063's CURRENT-UNIQUE; the W3C-D4-VERIFY-1
report's existence and content; source coverage of 223-715; the Tier C
sample; the settled 22 probes; Classification Repair v1.1; DEC-67; Review
Scope v1.15's substantive method; and the B2/D architecture.

The section-24 R8 filename correction is NOT new residue - it is a6's
already-recorded CITED-OUTSIDE-RANGE obligation from LED-063.
```


## 0a. RECOVERY GATE AFTER THE 2026-08-19 W3D SESSION LIMIT
##     [HISTORICAL - DISCHARGED AT DEC-70/DEC-73. RETAINED AS RECORD ONLY.]

```text
THIS GATE IS DISCHARGED AND IS NOT A LIVE INSTRUCTION.
It required a successor W3D to independently verify the W3C recovery ledger
v1.4 before a5 could close. W3X ruled v1.4 out as a source at DEC-70 and the
ledger was rebuilt textually on delivered v1.3, so there is no W3C-authored
artifact left for W3C to be asked to certify. DEC-73 returned a5 to ordinary
independent review.
THE TEXT BELOW IS PRESERVED UNCHANGED as the record of what was required and
why. Do not act on it.
```
...
```text
DEC-86  LEDGER v1.9 WAS NOT CLEAN; v1.10 IS THE DEC-85 FINAL GENERATION.
        W3C's response v1.3 found the substantive v1.8 findings correctly
        applied - LED-037a, LED-043, LED-047/047a's split direction, LED-053d,
        the LED-055 family, LED-061, LED-063's disposition - and source
        coverage substantively complete at 44 entries, all Tier C.
        WHAT FAILED WAS THE PARTIAL-REPLACEMENT CLASS AGAIN, INSIDE TEXT
        CLAIMING TO HAVE FIXED IT: LED-047's parent still opened "Both
        propositions" a generation after the split; LED-063 carried "But a
        STRONG LIKELY REFERENT does exist" DIRECTLY AFTER a note saying that
        sentence was removed - THE REMOVAL NOTE WENT IN AND THE REMOVAL DID
        NOT; LED-059's live ACTION still held its relocated history; LED-055a
        left one probe candidate opened but unclassified, which under scope
        0.3 Rule 1 means unswept.
        THE COUNT MACHINERY FAILED THREE WAYS: 0.4d printed 26 under a 28
        heading; Q-C counted 19 by first-line prefix, missing LED-054's
        mid-field claim; Q-H wrote "nine" above its own list of eleven.
        v1.10 applies all of it. NO new probes, NO resampling, NO method
        reopening, entry count unchanged at 44.
        UNDER DEC-85 THIS IS THE LAST a5 CORRECTION GENERATION. After W3C's
        final mechanical verification a5 CLOSES; residue goes to T1S01a7.
        (W3C reviewed; W3D applied 2026-08-20)

DEC-88  T1S01a5 IS CLOSED, WITH KNOWN RESIDUE CARRIED FORWARD.
        W3C's FINAL verification (response v1.4, 2026-08-21) reports v1.10 is
        NOT literally residue-free and that the adjudication is nevertheless
        STABLE ENOUGH TO CLOSE. W3C independently reproduced the population:
        44 entries, 16 CURRENT-UNIQUE, 28 CURRENT-DUPLICATE, zero CONFLICTING,
        zero SUPERSEDED, zero OPERATIVE-SPEC, all Tier C; source range 223-715
        substantively covered.
        THIS IS NOT "PASS DESPITE DEFECTS". It is the cap-and-carry model W3X
        ratified at DEC-85 after judging that continuing to chase a5 recovery
        residue had itself become the project risk. The residue is ENUMERATED
        at section 0c and ROUTED - R1-R6 to a7, R7 to the continuity refresh,
        R8 to the historical record - which is the point of closing this way
        rather than quietly.
        WHAT CLOSURE DOES NOT MEAN: nothing in a5 is ratified into any
        authority document. Every PROPOSED ACTION remains a proposal awaiting
        T3. Closure settles the ADJUDICATION, not its recommendations.
        THE RECORD WORTH KEEPING: across seven W3C review rounds - the Tier C
        sample, the re-sweep cross-check, the classification repair and four
        recovery-closure reviews - NOT ONE MPEG-2 CONCLUSION WAS OVERTURNED.
        Every round's cost was method, framing, provenance and recovery, the
        same pattern DEC-52 recorded for a4. That is the strongest available
        evidence that the technical work is sound and the PROCESS was what
        needed fixing.
        NEXT, IN ORDER: the bounded root-continuity refresh, deliberately
        deferred so the whole document set points at one settled endpoint,
        then T1S01a5b under Review Scope v1.15.
        (W3C verified; W3X recorded closure 2026-08-21)

DEC-87  TWO STANDING RULES ABOUT MECHANICAL GATES, LEARNED THE HARD WAY.
        (a) A FIX THAT IS NOT PERSISTED IS NOT A FIX. The 0.4d defect existed
        because a correcting edit was made in memory, verified in memory, and
        never written to disk before the next build step reopened the file.
        GATES MUST RUN ON THE ARTIFACT RE-READ FROM DISK, never on the text
        that claims to contain the repair.
        (b) A MECHANICAL COUNT IS ONLY AS GOOD AS THE RULE IT MECHANISES, AND
        A FIRING GATE IS AS LIKELY TO BE WRONG AS THE DOCUMENT. At v1.10 two
        gates fired FALSELY - counting LED-051a as a STAY-CANONICAL asserter
        when it only cross-references LED-045's requirement, and counting the
        COVERAGE entries LED-032a/LED-037a as atomic splits. Both times the
        document was right and the rule was wrong. WHEN A GATE FIRES,
        DETERMINE WHICH SIDE IS WRONG BEFORE EDITING ANYTHING; a gate trusted
        blindly corrupts the document it protects.
        (W3D self-diagnosed during the v1.10 build 2026-08-20)

DEC-85  W3X CAPS THE a5 CORRECTION ROUNDS: AT MOST TWO FURTHER GENERATIONS,
        THEN a5 CLOSES REGARDLESS.
        Ruled 2026-08-20 on W3D's Q34, after W3D reported honestly that its
        per-generation error rate was not falling fast - the atomic-claim
        failure recurred four times, its bounded probes were lexical where
        DEC-67 Rule 3 demands semantic, and stale-count residue escaped its
        own mechanical gate.
        LEDGER v1.9 IS THE FIRST OF THE TWO. If W3C's bounded re-review of
        v1.9 is clean, a5 closes there. If not, ONE more generation applies
        the findings and a5 closes with any remaining residue RECORDED AND
        CARRIED TO a7's whole-document consistency pass rather than chased
        further. W3C's own standing advice is the reason: do not let a5
        recovery become the project; a5b is the test of the machinery.
        (W3X ruled 2026-08-20)

DEC-84  THE SUPERSEDED-KIND / PROPAGATION WORDING IS RATIFIED - IN W3C's
        EXACT WORDING, NOT THE DEC-78/v1.13 TRANSCRIPTIONS.
        W3X ratified on 2026-08-20 the exact rule W3C supplied and re-checked
        at its v1_2 response Q2. The v1.13 scope transcription was NOT
        ratified: it shortened the final limit from "scope/method" to "scope"
        and dropped step 2's "using the method appropriate to the
        proposition". W3C flagged both as material - a narrow or unsuitable
        method must not gain apparent exhaustiveness merely because its scope
        was declared - and the a5 experience proves the point: two W3D probes
        failed exactly by being lexically narrow while honestly scoped.
        THE BINDING TEXT LIVES AT REVIEW SCOPE v1.14 SECTION 0.11 AND IS
        CITED, NEVER PARAPHRASED. DEC-64 is now fully in force; DEC-78 is
        superseded as a transcription record. It binds before T3 reaches the
        rejected Architecture-A material.
        (W3C verified twice; W3X ratified 2026-08-20)

DEC-83  REVIEW SCOPE SECTIONS 0.5, 0.6 AND 0.7 ARE RATIFIED.
        Occurrence-level evidence, CITED-OUTSIDE-RANGE, and the entry-sweep
        gate. THE I7 CHAIN USED FOUR ROLES ACROSS THREE PARTIES - corrected
        here because v1.34 said "four distinct parties" and W3C appears twice,
        in two different roles: W3C supplied the originating proposal and
        evidence (knowledge capture); W3D drafted and issued the criterion,
        which applies to W3D's own work (scope v1.12/v1.13); W3C INDEPENDENTLY
        VERIFIED the W3D-drafted criterion (v1_2 response Q1); W3X ratified it
        2026-08-20. THE INDEPENDENCE FACT IS UNAFFECTED - the party the
        criterion judges did not verify it - and DEC-83 is NOT reopened.
        The scope reissues as v1.14 with the three marked RATIFIED. They bind
        a5's remaining closure and all of a5b.
        (W3X ratified 2026-08-20)

DEC-82  THE SOURCE-COVERAGE MAP AND SUPERSEDED PROPAGATION ARE ADDED TO THE
        CONSOLIDATED SCOPE, AND THE SCOPE'S STATUS CLAIM IS CORRECTED.
        W3C DECLINED TO RATIFY REVIEW SCOPE v1.12 AND WAS RIGHT ON BOTH
        COUNTS.
        FIRST: v1.12 said every rule in its section 0 was "already binding
        through a ratified decision". FALSE for three - 0.5 occurrence-level
        evidence, 0.6 CITED-OUTSIDE-RANGE and 0.7 the entry-sweep gate are new
        W3C-originated criteria still mid-I7-chain. Recording a chain as
        complete while standing in the middle of it is DEC-48's false
        assurance, committed inside the document written to consolidate rules
        against that class of error. v1.13 marks every subsection [RATIFIED] or
        [VERIFIED - AWAITING W3X RATIFICATION].
        SECOND: the consolidation was INCOMPLETE ON THE DAY IT SHIPPED. DEC-77
        and DEC-64/78 were both absent, and DEC-77 explicitly binds a5b - the
        exact defect v1.12 existed to prevent. Both are now at scope 0.10 and
        0.11.
        (W3C found; W3D corrected 2026-08-20)

DEC-81  THE ENTRY-SWEEP GATE MUST BE RUN MECHANICALLY, NOT BY EYE.
        DEC-76 adopted the gate. At ledger v1.7 the designer APPLIED IT BY HAND
        and missed three defects - LED-043, LED-059 and LED-063 each kept a
        sentence contradicting its own repair, and W3C found all three.
        At v1.8 it was run as an actual DIFF of every edited entry for the
        terms that edit was meant to remove, discounting occurrences inside an
        explicit withdrawal record. IT IMMEDIATELY CAUGHT THREE MORE the
        designer had missed by eye, including a TIER FIELD LEFT STALE BY ITS
        OWN DISPOSITION CHANGE.
        THE RULE: A GATE APPLIED BY THE SAME ATTENTION THAT CAUSED THE DEFECT
        IS NOT A GATE. Where a check can be mechanised, mechanise it.
        (W3D self-diagnosed after W3C's delta review 2026-08-20)

DEC-80  W3C's DELTA REVIEW IS ACCEPTED IN FULL. a5 IS STILL NOT CLOSED.
        LED-063 IS THE CONSEQUENTIAL ONE AND IT IS GOOD NEWS. W3C's full
        Tier-A review OPENED the candidate document and established that the
        W3C verification report CONTENT SURVIVES - the W3C-D4-VERIFY-1 coder
        response carries V4.1 and V4.3 as VERIFIED, exactly what the authority
        cites. There is therefore NO CONFLICT between section 8 and section 24:
        R8 simply holds a WRONG FILENAME for a surviving document.
        LED-063 moves CONFLICTING -> CURRENT-UNIQUE, its tier recomputes A -> C
        under DEC-62, and THE LEDGER NOW HAS ZERO TIER A ENTRIES. W3C ruled in
        advance that a Tier-A count must not be preserved as a target.
        A SUSPECTED PROVENANCE HOLE IS CLOSED RATHER THAN OPENED. This thread
        had been running toward T8 and the F8 question since a5 began. It is a
        filename correction for a6, not missing evidence.
        ALSO APPLIED: LED-055a's invalid uniqueness argument - "no other
        document states BOTH in the same complete form" proves only that the
        CONJUNCTION is unique - with the progressive-material generality split
        to LED-055b as CURRENT-DUPLICATE; bounded proposition-specific probes
        for LED-037a and LED-055a; LED-047's claim NARROWED to the F-to-V
        mapping, since four Scopes documents carry the verification content
        itself; LED-053d's stretched MIXED replaced by occurrence-level
        evidence; and three more stale sentences contradicting their own
        repairs.
        ENTRY COUNT 42 -> 43.
        THREE BOUNDED PROBES WERE RUN, EACH FOR A NEW OR NEWLY-NARROWED
        PROPOSITION. The settled 22-probe round was NOT rerun, no Tier C
        resample was taken, and no method or architecture question was
        reopened.
        (W3C reviewed; W3D accepted 2026-08-20)

DEC-79  THE REVIEW METHOD IS CONSOLIDATED INTO REVIEW SCOPE v1.12.
        THE PROBLEM: the binding review scope stopped containing the binding
        rules. They accumulated in this decision log - DEC-50, DEC-51, DEC-60,
        DEC-62, DEC-63, DEC-66, DEC-67 - and in Classification Repair v1.1's
        label definitions, while Review Scope v1.11 kept only the original
        method. A successor designer read v1.11's generic "Tier C: W3X selects
        a random sample", saw nothing there saying a5's sample was complete,
        and asked W3X for something already provided. IT COST A ROUND.
        THAT IS THE FOUNDING INCIDENT, ONE LEVEL UP: ratified material sitting
        unread in a document nobody consolidated.
        NO SUBSTANTIVE RULE CHANGES. Section 0 of v1.12 gathers what was
        already binding, and adds three W3C-originated refinements: 0.5
        occurrence-level evidence, 0.6 CITED-OUTSIDE-RANGE, 0.7 the
        entry-sweep gate.
        I7 CHAIN: W3C PROPOSED it, W3D drafted it, W3C verifies it, W3X
        ratifies - the party the criteria judge is not the party that asked.
        (W3C proposed; W3D drafted 2026-08-19)

DEC-78  DEC-64 CAN NOW BIND - W3C HAS SUPPLIED THE VERIFIED WORDING.
        DEC-64 was ratified SUBJECT TO W3C wording verification and has not
        been binding since. W3C's knowledge-capture debrief supplies it:
            SUPERSEDED-KIND   OVERTAKEN | ERRONEOUS
            OVERTAKEN   valid in its former context and replaced by a later
                        statement; PROPAGATION normally N/A unless evidence
                        suggests dependent work may not remain valid.
            ERRONEOUS   false, materially misleading or otherwise invalid in
                        the context in which project work may have relied on
                        it. PROPAGATION REQUIRED, in six steps: declare the
                        bounded propagation scope; search for RELIANCE on the
                        proposition rather than its wording; enumerate and
                        classify candidate dependencies with attackable basis;
                        route each actual dependency; record "none found" with
                        scope and method if none; claim no exhaustiveness
                        beyond the declared scope.
        PROPAGATION IS ABOUT POTENTIALLY AFFECTED CURRENT WORK, NOT an
        archaeological search for every historical mention.
        IT MUST BIND BEFORE T3 REACHES THE REJECTED ARCHITECTURE-A MATERIAL -
        the first real ERRONEOUS case, and where getting it wrong costs most.
        W3X ratification of this exact wording is what makes it binding.
        (W3C verified; W3D transcribed 2026-08-19)

DEC-77  THE a5 LEDGER'S COVERAGE CHECK WAS THE WRONG CHECK, AND IS FIXED.
        Section 0.2 of the ledger has enumerated its overlap against 33 prior
        entries since v1.0, meticulously and correctly. IT NEVER WALKED THE
        SOURCE RANGE LOOKING FOR PROPOSITIONS WITH NO ENTRY. Two were missing
        from inside the declared 223-715 range - authority line 225's
        project-scope statement and line 269's default-scope qualification -
        and survived five ledger generations and a Tier C sample before W3C
        checked the source against the entry ranges.
        THE RULE: AN OVERLAP CHECK AGAINST PRIOR ENTRIES IS NOT A COVERAGE
        CHECK AGAINST THE SOURCE. Every sub-tranche owes both, and a5b must
        produce its exact coverage map BEFORE adjudication rather than after.
        (W3C found; recorded 2026-08-19)

DEC-76  THE ENTRY-SWEEP GATE IS ADOPTED.
        AFTER EDITING ANY FIELD OF AN ENTRY, RE-READ THE WHOLE ENTRY AND CHECK
        THAT NO OTHER FIELD CONTRADICTS THE EDIT.
        WHY: at ledger v1.5 and v1.6 the designer corrected exactly the field
        each mandate named and left the rest stale, three times. LED-055 kept
        "the DERIVATION -> this section, uniquely" in PREVAILS after
        withdrawing it in REASON - surviving TWO corrections. LED-061's
        rebuilt SWEPT classified two files as DIFFERENT while REASON and
        DUPLICATE-ACTION still listed them as carriers, so THE ENTRY
        CONTRADICTED ITSELF. LED-043 kept a DEC-66-excluded population in the
        half of SWEPT that was not rebuilt.
        THIS IS DEC-51 AT ENTRY LEVEL, committed three times by the ledger
        that enumerates DEC-51. It is partly mechanical: after each edit, diff
        the entry's remaining fields for the terms the edit removed.
        SAME DISCIPLINE, LARGER SCOPES: enumerate the ROUNDS an instruction
        came from, not only the deltas; and never name a document as used
        unless it was opened.
        (W3D self-diagnosed; W3C confirmed 2026-08-19)

DEC-75  W3C's RECOVERY-CLOSURE REVIEW IS ACCEPTED IN FULL; a5 IS NOT CLOSED.
        W3C reviewed ledger v1.6 and required a bounded reissue. W3D accepts
        every finding. Ledger v1.7 applies them: two uncovered propositions
        captured (DEC-77), three partial Tier C replacements completed
        end-to-end (DEC-76), LED-047's literal-string count corrected from
        seven to eight, LED-059's false section-15 canonical home withdrawn
        after W3C read section 15 and found the composition is not there, and
        LED-063's "may not exist" separated into a wrong filename with a
        strong likely surviving referent - the W3C-D4-VERIFY-1 coder response.
        ENTRY COUNT 39 -> 42.
        EXPLICITLY NOT DONE, at W3C's own insistence: no Tier C resampling, no
        rerun of the settled 22 probes, no DEC-67 reopening, no architecture
        reopening.
        CORRECTED AT DEC-80: this decision said the three partial Tier C
        replacements were applied "end-to-end" at v1.7. THEY WERE NOT - all
        three still contained a stale contradicting sentence, fixed at v1.8.
        THE TECHNICAL ADJUDICATION HAS HELD THROUGHOUT. Across five rounds no
        MPEG-2 conclusion has been overturned; the cost has been method,
        framing and recovery - the same pattern DEC-52 recorded for a4.
        W3C's closing advice is adopted: DO NOT LET a5 RECOVERY BECOME THE
        PROJECT. Close a5 on these corrections; a5b is the next useful test.
        (W3C reviewed; W3D accepted 2026-08-19)
...
DEC-62  THE a5 TIER LABELS WERE WRONG ON 31 OF 34 ENTRIES, AND THE DIRECTION
        ...
        W3X ACTION NOW OWED [RESOLVED 2026-08-19 - W3X selected the
        eleven-entry Tier C sample; W3C reviewed exactly those eleven;
        3 AGREE / 8 DISAGREE; DEC-73 closes it and forbids resampling]: 33 entries are Tier C, so W3X must select the
...
```text
PURPOSE: the T1 sweep proves the corpus is internally consistent. It cannot
prove the foundations. Architecture B2 stands on a bounded set of EXTERNAL
facts that the corpus can only cite:
    - H.262 subclause 6.1.3 - 4:2:0 chroma DCT blocks are always frame-
      organised; the citation that resolved the suspected Classic chroma
      defect and that the authority's chroma treatment rests on;
    - H.264 clause 8.7 MBAFF concepts - the verified conceptual precedent
      behind the mixed-boundary rule (authority section 10.2; CONCEPT only,
      no code or mathematics inherited);
    - RFC 6386 section 15 - the VP8 loop-filter ordering and geometry
      material cited in the README;
    - the section-8 external research-assessment retentions.

EBR is the terminal cross-check that none of these has been invalidated or
superseded since it was verified.

WHY IT MATTERS: if a foundation stone has moved, the sweep's own dependency
map must trace what stood on it - the [SPEC-VERIFIED] tags, the
CITED-OUTSIDE-RANGE records, the D4 decision registers and DEC-84
propagation. A failure that routes cleanly is the process WORKING AS
INTENDED. A failure that cannot be traced is a PROCESS finding, and it
outranks the external fact that exposed it.

METHOD:
  1. ENUMERATE every external-basis claim - from the [SPEC-VERIFIED] tags,
     the section 7 prior-art items, the section 8 retentions and the README
     external citations. Declared population per DEC-50; no remembered
     counts.
  2. RE-VERIFY each against the LIVE primary source at execution time,
     independently of the corpus's own record of it.
  3. CLASSIFY each: VALID / INVALIDATED / SUPERSEDED / UNVERIFIABLE.
  4. PROPAGATE under DEC-84 (Review Scope 0.11, cited not paraphrased) for
     anything not VALID.
  5. SOURCES: W3X may need to supply ITU specification PDFs, as in the
     PreScope round. RFC 6386 is freely fetchable.

SEQUENCING: runs after T1 completes IN FULL - all remaining a5b batches, a6
and T1S02 - and BEFORE T3 edits are ratified and before T6/Q14 or any kernel
scope opens. It is the last gate before irreversible work stands on the
foundation.

ORIGIN: proposed by W3X on 2026-08-22 as the check that proves the sweep
process worked as intended. Companion record: T1 Resume Brief v1.17 section
0-CURRENT.
```
...
```text
v1.37 (2026-08-22) REGISTERS T9, the External Basis Revalidation (EBR) gate,
     on W3X's 2026-08-22 ruling: a terminal cross-check that B2's external
     evidence (H.262 6.1.3; H.264 8.7 MBAFF concepts; RFC 6386 section 15;
     the section-8 research retentions) has not been invalidated or
     superseded, run against live primary sources after T1 completes in full
     and before T3 ratification or any T6/Q14 or kernel scope. Adds the 0.1
     sequencing row, T9 gate notes on the T3 and T6 rows, and the full T9
     task section before T7. INSERTIONS ONLY - no existing line was altered,
     reworded or removed; verified by line-multiset comparison against v1.36.
     Companion record: T1 Resume Brief v1.17 section 0-CURRENT.
     OBSERVED, NOT REPAIRED: this revision list jumps from v1.30 to v1.0 -
     the notes for v1.31 through v1.36 (and v1.13-v1.21) were never written
     into it. Their content is not reconstructed here, because inventing it
     would be worse than the gap. W3D flags it for W3X; the header's author
     line does record v1.31's substance.
