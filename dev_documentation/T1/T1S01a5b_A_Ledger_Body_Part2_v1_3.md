...
**Date:** 2026-08-22
**Author:** W3D
**Status:** ADJUDICATION LEDGER, BATCH 1 SECOND CORRECTION GENERATION per
W3C correction review T1S01a5b_B v2 (findings F10-F15) - authority
...
and supersedes v1.2. Correction review 2 is bounded to six items: LED-066
(with new LED-066b), LED-070b, LED-074b, LED-079's REPAIR block,
LED-081a's PROPAGATION record, and this header/coverage metadata (F15).
All other entries carry their recorded verdicts and are not reopened.
...
line 741). There is no target entry count.
```
...
LED-066   (re-reissued at v1.3 per T1S01a5b_B v2 F10: the Evaluation
           ...
           carrier - is split to LED-066b. Token-level split of line 741,
...
LED-066b  (new at v1.3 per T1S01a5b_B v2 F10: the no-multiply token of
  ...
  --- WHAT THE DOCUMENT SAYS ---
  DOCUMENT     MPEG-2 authority v1.05, section 9.1, line 741 (the
  ...
  SWEPT        Population: 38 files (Population Delta v1.1). Per scope
               ...
               "multiplication"}. Eleven loci in eight files, every one
  ...
  DERIVED      A wording-scope observation, recorded without proposing
               ...
               line 741 is a latent ambiguity a future authority bump
...
ENTRIES THIS BATCH: 29 (v1.2's 28 plus LED-066b, added at v1.3)
    ...
    LED-066  CURRENT-DUPLICATE  STAY-CANONICAL   C   re-reissued (F10)
    LED-066a CURRENT-UNIQUE     n/a              C   AGREE (B v2)
    LED-066b CURRENT-UNIQUE     n/a              C   new (F10)
    ...
    LED-070b CURRENT-DUPLICATE  STAY-CANONICAL   C   repaired (F11)
    ...
    LED-074b CURRENT-DUPLICATE  STAY-CANONICAL   C   re-reissued (F12)
    ...
    LED-079  CURRENT-DUPLICATE  STAY-CANONICAL   C   repaired (F13)
    LED-080  CURRENT-DUPLICATE  STAY-CANONICAL   C   AGREE (B)
    LED-081  CURRENT-DUPLICATE  STAY-CANONICAL   C   AGREE (B v2)
    LED-081a SUPERSEDED (ERRONEOUS)  n/a         A   repaired (F14)
...
REVIEW STATE: 23 entries carry recorded AGREE verdicts (12 from
T1S01a5b_B, 11 from T1S01a5b_B v2) and are not reopened. Six items are
open for correction review 2, bounded per T1S01a5b_B v2 section 10:
LED-066 (re-reissued), LED-066b (new), LED-070b, LED-074b (re-reissued),
LED-079's REPAIR block, LED-081a's PROPAGATION record - plus the F15
header/coverage metadata repairs, which sit outside any verdict field.
