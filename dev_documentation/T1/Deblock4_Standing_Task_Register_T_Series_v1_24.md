...
```text
  T1        Formal consolidation sweep ......... IN PROGRESS.
                                                 ...
                                                 WORK: BODY PART 1, sections
                                                 1-13. THEN a6 (body part 2)
                                                 and a7, the DECLARED FINAL
                                                 sub-tranche carrying the six
                                                 owed items and the
                                                 consistency pass - DEC-53.
                                                 DECLARED RANGES ARE EXACT
                                                 (DEC-56): a5 = lines
                                                 223-1098; a6 = 1099-1676
                                                 PLUS 1717-1932, which now
                                                 includes section 24
                                                 (DEC-55); a7 = the older
                                                 Appendix E entries, the six
                                                 owed items and the
                                                 consistency check due only
                                                 at a document's FINAL
                                                 sub-tranche.
  ...
  CURRENT RESUME ORDER FOR A NEW W3D:
      Deblock4_T1_Resume_Brief section 0a, HIGHEST COMMITTED VERSION -
         it is bumped as the sweep advances and this register is not, so
         where the two disagree on STATE the brief is right
      -> Project Status section 0, HIGHEST COMMITTED VERSION
      -> MPEG-2 authority v1.05 section 0 (still v1.05 deliberately; a
         higher generation means something was ratified - stop and ask W3X)
...
DEC-41  THE FAILURE TALLY IS NOW TEN, AND THE LAST SEVEN POST-DATE THE
        ...
        INSTANCE 8 IS THE MOST INSTRUCTIVE OF THE TEN, and it is the one
        ...
        WHAT ACTUALLY CAUGHT ALL TEN: an independent party reading the whole
        artifact rather than the part under discussion. W3C caught 1-4, 7 and
        9; successor designers caught 5, 6 and 10. Instance 8 was caught by
        ...
        then. NOT ONE OF THE TEN WAS CAUGHT BY ITS AUTHOR, AND NOT ONE WAS
