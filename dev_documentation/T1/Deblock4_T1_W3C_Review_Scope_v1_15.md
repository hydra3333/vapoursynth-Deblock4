...
**Version:** 1.15 - RATIFIED CONSOLIDATED METHOD
**Date:** 2026-08-20
...
READ THE STATUS MARKERS - each subsection below carries one:
    ...
    [RATIFIED - DEC-83]   a criterion originated by W3C, drafted by W3D,
                 ...
                 RATIFIED BY W3X on 2026-08-20.
                 THE CHAIN USED FOUR ROLES ACROSS THREE PARTIES: W3C supplied
                 the originating proposal and evidence; W3D drafted and issued
                 the criterion, which applies to W3D's own work; W3C
                 independently verified the W3D-drafted criterion; W3X
                 ratified it. (v1.15: v1.14 said "four distinct parties",
                 which was simply miscounted - W3C appears twice, in two
                 different roles. THE INDEPENDENCE FACT IS UNAFFECTED and
                 DEC-83 is not reopened: the party the criterion judges did
                 not verify it.)
...
*Revision history*
```text
v1.15 (2026-08-20) FINAL MECHANICAL REISSUE. NO SUBSTANTIVE RULE CHANGED.
     Corrects the DEC-83 provenance wording from "four distinct parties" to
     four roles across three parties, W3C appearing as both originator and
     independent verifier - a miscount, not a defect in the chain; DEC-83 is
     NOT reopened. Corrects the header metadata date to 2026-08-20.
