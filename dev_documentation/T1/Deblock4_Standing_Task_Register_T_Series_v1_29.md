...
```text
  ...
  T8        Close the provenance gaps T1 finds . OPEN; feeds T5
  T7        Final consolidation commit ......... BLOCKED by T1-T6, T8
...
SEQUENCING: T8 runs BEFORE T5, not before Q14. T5 derives detector
