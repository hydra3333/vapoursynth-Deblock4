...
READ THE STATUS MARKERS - each subsection below carries one:
    ...
    [VERIFIED - AWAITING W3X RATIFICATION]   a NEW criterion originated by
                 W3C, drafted by W3D, and VERIFIED BY W3C at the delta review
                 of 2026-08-20. The I7 chain is complete except for the final
                 W3X ratification. IT IS NOT YET BINDING.
...
## 0.5 OCCURRENCE-LEVEL EVIDENCE   [VERIFIED - AWAITING W3X RATIFICATION]
...
## 0.6 CITED-OUTSIDE-RANGE   [VERIFIED - AWAITING W3X RATIFICATION]
...
## 0.7 THE ENTRY-SWEEP GATE   [VERIFIED - AWAITING W3X RATIFICATION]
...
## 0.11 SUPERSEDED-KIND AND PROPAGATION   [DEC-64 wording VERIFIED BY W3C; AWAITING W3X RATIFICATION]

```text
DEC-64 was ratified SUBJECT TO W3C wording verification and has NOT been
binding since. W3C supplied the verified wording in its knowledge-capture
response and confirmed the transcription at DEC-78. W3X ratification of that
wording is the last link.

IT MUST BIND BEFORE T3 REACHES THE REJECTED ARCHITECTURE-A MATERIAL - the first
real ERRONEOUS case, and where getting it wrong costs most.

    SUPERSEDED-KIND    OVERTAKEN | ERRONEOUS

    OVERTAKEN   valid in its former context or state, and replaced by a later
    ...
    ERRONEOUS   false, materially misleading, or otherwise invalid in the
                ...
                PROPAGATION IS REQUIRED, in six steps:
                  1. DECLARE THE PROPAGATION SCOPE - the bounded set of current
                     documents, decisions, code, mathematics or tests in which
                     reliance could materially survive;
                  2. SEARCH FOR RELIANCE ON THE PROPOSITION, not merely for its
                     wording;
                  3. ENUMERATE AND CLASSIFY candidate dependencies, identifying
                     actual reliance and non-reliance with attackable basis;
                  4. ROUTE EACH ACTUAL DEPENDENCY - valid for an independent
                     reason; needs correction or re-verification; or is itself
                     superseded or erroneous;
                  5. If none are found, record "none found" WITH its scope and
                     method;
