...
| Zig/C ownership and lifetime policy | Recorded in charter (current v1.14) |
| Numeric and SIMD helper policy | Recorded in charter (current v1.14) |
| External-source provenance policy | Recorded in charter (current v1.14) |
...
111_New_Chat_Introduction_for_Coder_v1_4.md
```
...
1. the charter's canonical filename and internal version both say v1.14;
2. the README's filename and internal design revision both say v1.7;
...
build then runs for Classic first, then Deblock4. See README v1.7 section 1.0.
...
v1.6  Independent re-audit corrections (H1/H2): authority block, evidence basis,
      ...
      set (charter v1.14, README v1.7, decisions v1.6, roadmap v1.6, concise
