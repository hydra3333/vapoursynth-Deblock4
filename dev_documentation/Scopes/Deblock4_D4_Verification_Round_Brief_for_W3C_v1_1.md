...
document v1_3.
**Context supplied:** the GAIS investigation brief v1_0, BOTH GAIS answers
(the original two-part answer AND the follow-up answer to our critique with
its replacement citations), and the W3D assessments. Read all first.
...
One .md report, sections V1-V4 (incl. V3b), each finding classified, every claim carrying
