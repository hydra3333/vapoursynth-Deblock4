...
W3D review v1_0). IMPLEMENTATION RELEASED. W3X supplies the current
documentation package (charter v1_29 generation) with this scope; W3C
performs the final delta knowledge sweep against it before coding
(5C-RAT-1).
