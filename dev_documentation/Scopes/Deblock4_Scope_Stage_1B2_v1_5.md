...
Inputs supplied:
    - this scope (Deblock4_Scope_Stage_1B2_v1_5.md);
...
[V4] NEW within-level gate (Part 3.1): per-object disassembly classified; each
     ...
     FAILS loudly on any out-of-level instruction.
...
[ ] Deblock4_Stage_1B2_WithinLevel_Report.md produced with contents A-F of
    ...
    membership incl. OSXSAVE; B separate XGETBV/XCR0 OS-state register read; C Zig
    resolved set for
