...
# 10. Binding Knowledge Checklist (D0 v1_10)
...
K30    the new first-class modules these obligations judge obey the
       ...
       obligation, named in the 7d crosswalk with its exact domain (D4
       section 9 K30).
K31    stride units explicit and checked even in scalar code
       (C-SIMD-03): byte addressing with the unit named, or exactly ONE
       checked conversion naming both units; silent division forbidden.
       Proof rides O-6e canaries and O-8c/O-8h plus code inspection (D4
       section 9 K31).
