...
W3C PROPOSED THIS CONSOLIDATION. NO SUBSTANTIVE RULE IS CHANGED BY IT. Every
rule below was already binding through a ratified decision; what changes is
that they are now in one place, in the document that claims to be binding.
```

## 0.1 STANDING NOTICE - T1S01a5 TIER C IS COMPLETE
...
## 0.2 THE POPULATIONS, AND THE THREE MECHANICAL EXCLUSIONS
...
## 0.3 THE THREE SWEEP RULES, AND THE COROLLARY THAT MATTERS MOST
...
## 0.5 OCCURRENCE-LEVEL EVIDENCE - NEW AT v1.12
...
## 0.6 CITED-OUTSIDE-RANGE - NEW AT v1.12
...
## 0.7 THE ENTRY-SWEEP GATE - NEW AT v1.12
...
## 0.8 CHECK EVIDENCE AND PARTIAL REPLACEMENT
...
## 0.9 FORM WITHOUT PURPOSE - HOW THESE RULES FAIL WHILE BEING FOLLOWED
