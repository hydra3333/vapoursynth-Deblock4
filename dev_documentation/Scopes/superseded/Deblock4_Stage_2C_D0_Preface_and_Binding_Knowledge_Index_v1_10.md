...
K30 FIRST-CLASS MODULE DISCIPLINE APPLIES TO THE NEW 2C MODULES
      ...
      OBLIGATION of the 2C scope, named in the O/G crosswalk with its
      exact domain (the new modules plus every existing module the
      scope edits). Applies: D4 sections 1/7/9; every later stage that
      adds first-class modules.
K31 STRIDE UNITS ARE EXPLICIT AND CHECKED, EVEN IN SCALAR CODE
      ...
      alike. Proof: code inspection plus the conversion assertion,
      riding the D3 O-6e canaries and O-8c/O-8h per-plane geometry
      tests. Applies: D4 A1c/A6; 4C/5C vector addressing later.
```
...
backend refusal carried by creation-error table v1_6, (c) the Classic-
