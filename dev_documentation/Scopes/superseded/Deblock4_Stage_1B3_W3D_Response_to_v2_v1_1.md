...
Against: scope v1.3, charter v1.19 (ratifies the section-3 ruling), and the
   W3D v1 delivery review.
...
## 3. The line-ending ruling (W3X-RATIFIED; charter v1.19 records it)
...
R4. C-DELIV-06 is AMENDED: charter v1.19 (ratified 2026-07-31) now carries
    the CRLF rule, the pinned git configuration, the scaffolding exception,
    and the state-the-conflict-and-stop rule. v1.19 is the controlling
    charter for the v3 re-emission and everything after.
