...
**Status:** W3X-RATIFIED 2026-08-15 (acceptance basis = INERTNESS; the
two-file comments-only surface; the short R1-R4 pre-implementation round all
ratified). RELEASED to W3C for the pre-implementation round; implementation
begins only after W3X ratifies that round's outcome.
