...
**Version:** 1.7
**Date:** 2026-07-29
**Status:** Orientation only; not controlling; not a coding scope. Aligned to charter v1.15, README v1.8.
**Author:** W3D designer
...
Status (v1.7): Stages 1A, 1A.1 and 1B.1 are COMPLETE and committed. Stage 1B.2
...
Classic series (2C..5C) first, then a Deblock4 series (2D..5D). See README v1.8
