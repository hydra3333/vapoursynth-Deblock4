...
# 0. STATE ADVANCE (v1.35, 2026-08-21) - read this first: T1S01a5 IS CLOSED;
# THE RECOVERY ARC IS OVER; a5b IS THE NEXT WORK

```text
NO CODE HAS CHANGED.
Identity remains 0.1.0-dev+5C. Classic is COMPLETE for the ratified integer
set (2C scalar oracle, 4C SSE4.1, 5C AVX2, post-5C M1/M2). The Deblock4 filter
still has NO FILTERING KERNEL; its live dispatch remains writable-copy /
pass-through infrastructure.

MPEG-2 ARCHITECTURE IS UNCHANGED:
    B2 primary candidate;
    D mandatory detector-free comparator/fallback;
    A and C rejected;
    Q14 decides what, if anything, may enter later kernel/oracle development.
No kernel scope may be drafted before Q14 reports and W3X ratifies that entry.

T1S01a5 CLOSED 2026-08-21 UNDER DEC-85 AND DEC-88.
    FINAL LEDGER: T1S01a5_A_Ledger_Body_Part1_v1_10.md - 44 entries, ALL
    Tier C (16 CURRENT-UNIQUE, 28 CURRENT-DUPLICATE, zero CONFLICTING, zero
    SUPERSEDED, zero OPERATIVE-SPEC), every figure independently reproduced
    by W3C at its FINAL verification (response v1.4, 2026-08-21).
    Source range 223-715 substantively covered.

HOW THE v1.34 GATE ACTUALLY RESOLVED, because v1.34 below expected a
different route: the W3C recovery reconstruction (ledger v1.4) was RULED OUT
as a source at DEC-70. The successor W3D instead REBUILT the ledger textually
on the delivered v1.3 basis plus the ratified findings, and it then took
SEVEN W3C REVIEW ROUNDS (generations v1.5 through v1.10) to reach closure.
W3X capped the correction rounds at DEC-85 - cap-and-carry - after the
recovery loop itself became the project risk, and DEC-88 recorded closure.

CLOSED WITH KNOWN RESIDUE, ON THE RECORD: R1-R8, enumerated and ROUTED at
Standing Task Register v1.36 section 0c (R1-R6 to a7's consistency pass, R7
to this continuity refresh, R8 to the historical record). NO a5 correction
generation may be opened for any of it; there is no v1.11 and will not be.

WHAT CLOSURE DOES NOT MEAN: nothing in a5 is ratified into any authority
document. Every PROPOSED ACTION in the ledger remains a proposal awaiting T3.

THE RECORD THAT MATTERS FOR VIABILITY: across all seven rounds NOT ONE MPEG-2
CONCLUSION WAS OVERTURNED. Every round's cost was method, framing, provenance
and recovery - the a4 pattern (DEC-52) repeated at larger scale. The
technical adjudication is sound; the process was what needed fixing, and the
fixes are now ratified machinery: Review Scope v1.15 is the RATIFIED
consolidated method (DEC-83 for occurrence-level evidence,
CITED-OUTSIDE-RANGE and the mechanical entry-sweep gate; DEC-84 for the exact
SUPERSEDED-KIND/propagation wording), and DEC-87 records the two
gate-machinery rules learned the hard way.

CURRENT T1 SUB-TRANCHE STATE:
    a1   CLOSED by decision.
    a2   CLOSED; reissued v1.1.
    a3   CLOSED provisionally.
    a4   CLOSED (DEC-52).
    a5   CLOSED (DEC-85/DEC-88); residue R1-R8 routed at register 0c.
    a5b  NEXT. Authority sections 9-13, lines 716-1098, under Review Scope
         v1.15. MUST derive its own population and produce a source-coverage
         map BEFORE adjudication (DEC-77 / scope 0.10). Expect the harder,
         architecture-heavy half.
    a6   not started; owes the section-24 R8 filename correction via
         LED-063's CITED-OUTSIDE-RANGE record.
    a7   not started; owes the whole-document consistency pass including
         residue R1-R6.

THIS REFRESH: Project Status v1.35, Forward Roadmap v1.24, Documentation
Currency Audit v1.8, Concise Project Summary v1.8 and the four orientation
files are being advanced together in one bounded pass against this single
settled endpoint - deliberately deferred until closure so it happens once.

AFTER a5b: W3X's explicit project-viability decision point (deliberately
placed AFTER seeing whether the ratified machinery makes a5b cheaper).
```

---

# 0-prior. STATE ADVANCE (v1.34, 2026-08-19) - HISTORICAL: W3D SESSION
# RECOVERED; a5 SEARCH/CLASSIFICATION SETTLED; the recovery-verification gate
# described below was OVERTAKEN by DEC-70 (v1.4 ruled out; textual rebuild on
# v1.3) - see v1.35 above for how it actually resolved
...
THE IMMEDIATELY PRECEDING W3D CHAT DIED AFTER DELIVERING:
    T1S01a5_A_Classification_Repair_v1_1.md
and BEFORE delivering its promised rewritten a5 ledger.

THE CLASSIFICATION-REPAIR WORK ITSELF IS SETTLED:
    - W3C independently reproduced the 46-file a5 search population;
    - W3C reproduced all 22 probe counts exactly;
    - W3C substantively PASSED repair v1.0 subject to three mechanical fixes;
    - W3D repair v1.1 visibly makes exactly those fixes;
    - no new a5 search/classification round is indicated.

W3C THEN CREATED A RECOVERY RECONSTRUCTION:
    T1S01a5_A_Ledger_Body_Part1_v1_4.md
from the physically delivered ledger v1.3 + Classification Repair v1.1 +
W3D-accepted W3C findings.

IMPORTANT INDEPENDENCE BOUNDARY:
    ledger v1.4 is W3C-AUTHORED RECOVERY MATERIAL. It must NOT be presented to
    a later W3C session as though it were a W3D proposal already eligible for
    independent W3C review. A chat reset does not create a different party.

WHAT REMAINS BEFORE a5b:
    successor W3D independently verifies/adopts/corrects recovery ledger v1.4;
    then W3X chooses/closes the one-off a5 recovery-review route.
    Only after that does T1S01a5b start.

CURRENT T1 SUB-TRANCHE STATE:
    a1   CLOSED by decision.
    a2   CLOSED; reissued v1.1.
    a3   CLOSED provisionally.
    a4   CLOSED provisionally.
    a5   RECOVERY VERIFICATION / FORMAL CLOSURE PENDING.
    a5b  NOT STARTED; ratified split, sections 9-13.
    a6   NOT STARTED.
    a7   NOT STARTED; declared FINAL a-tranche.
    b    NOT STARTED; SCOPES-ONLY under DEC-66.

CURRENT POPULATIONS - DO NOT CONFLATE:
    historical frozen T1S00 survey ............ 47 documents;
    current T1 adjudication population ........ 41 documents;
    settled a5 repair/search snapshot ......... 46 files.

CURRENT SEARCH/ADJUDICATION EXCLUSIONS:
    superseded*/scheduled_for_deletion* paths;
    T1/ - workshop/process tree, not applicable knowledge;
    GAIS_investigations/ - ignored for T1 search AND adjudication.

CURRENT HIGH-LEVEL SEQUENCE:
    finish T1 -> T8 provenance-gap closure -> T5 detector mathematics
    -> separately-ratified T6/Q14 planning.

T1S00 MANIFEST v1.5 IS A DELIVERY-DESCRIBING-ONLY BUMP. Its frozen 90-term
frame, 47-document survey tables, hit counts and recorded weaknesses were NOT
reopened or rewritten.

THE LIVE T1 TASK HANDOFF IS Deblock4_T1_Resume_Brief section 0a, highest
committed version. If this status document and that brief ever disagree during
T1, the resume brief wins.

SNAPSHOT RULE FOR a5 EVIDENCE:
    a5's 46-file re-sweep/classification-repair evidence is the settled
    recovery snapshot. Later continuity-document version bumps do not
    retroactively rewrite those candidate sets or counts.


ALL EARLIER `# 0. STATE ADVANCE` SECTIONS BELOW ARE HISTORICAL SNAPSHOTS.
They are retained to preserve project history and may contain then-current
phrasing, populations or next actions that v1.34 has superseded.
```
...
This document records the current implementation/proof state, active recovery
state and next bounded action. It is **informative**. It does not define the
algorithm, amend the charter, ratify a ledger remedy or release a coding scope.

Current authority/routing order:

```text
AI_Charter_and_Invariants_Card, highest committed
    project rulebook; PREVAILS.

Deblock4_MPEG2_Deblocking_Investigation_and_Decided_Architecture_v1_05.md
    PREVAILING RATIFIED MPEG-2/Deblock4 authority unless W3X supplies a later
    ratified generation. It prevails over README/orientation/history for
    MPEG-2 facts, architecture, mathematics and D4 decisions.

Deblock4_T1_Resume_Brief, highest committed, section 0a
    live T1 recovery/task handoff while T1 is active.

Deblock4_Standing_Task_Register_T_Series, highest committed
    work queue/dependency/decision-log record; not an architecture authority.

Deblock4_T1_W3C_Review_Scope, highest committed
    binds W3C's T1 review when such review is active.

README_Deblock4_Design_Spec, highest applicable generation
    general design/history/specification content, subordinate to the ratified
    MPEG-2 authority on MPEG-2-specific conflict.

Deblock4_Verification_And_Tiering_Decisions,
Deblock4_Toolchain_Findings,
Deblock4_Stage_2C_D0_Preface_and_Binding_Knowledge_Index,
other current applicable reference/scope records
    established knowledge in their own domains, as named by the active task.
```

Current applicability exclusions for T1:

```text
superseded*/scheduled_for_deletion*  excluded;
T1/                                  process/workshop, not applicable knowledge;
GAIS_investigations/                 ignored for T1 search/adjudication.
```

If this status conflicts with the charter, ratified MPEG-2 authority, a binding
active scope, or Resume Brief section 0a's live T1 task state, the applicable
higher authority/live handoff prevails.

# 2. Evidence basis

The implementation state below is grounded in the accepted project record
through Classic Stage 5C and post-5C M1/M2, plus the W3X-supplied/current source
state referenced by the recovery documentation. W3X remains the authority for
actual builds, runs, measurements, commits, pushes and project PASS/acceptance.

The T1 recovery state is grounded in the physically delivered W3D artifacts,
W3C's prior independent reviews, the Standing Task Register decision log, the
2026-08-19 reconstruction note supplied by W3X, and the explicitly labelled
W3C recovery artifacts created after the W3D chat died.

A recovery reconstruction is not transformed into independently verified work
merely because a new chat of the same role later reads it. Authorship/party
identity is therefore part of the evidence basis and is recorded explicitly.

# 3. Current position

The accepted implementation baseline is `0.1.0-dev+5C` plus the completed M1/M2
maintenance commits. Classic is complete for the ratified integer tier set.
Deblock4 is not: it has creation/dispatch/pass-through infrastructure but **no
filtering kernel**.

```text
IMPLEMENTATION:
    Stage 1 / 1C shared infrastructure ........ COMPLETE.
    Stage 2C Classic scalar oracle ............ COMPLETE.
    Stage 3C .................................. COLLAPSED; quality item deferred.
    Stage 4C Classic SSE4.1 backend ........... COMPLETE.
    Stage 5C Classic AVX2 backend ............. COMPLETE.
    Post-5C M1/M2 ............................. COMPLETE.
    Identity .................................. 0.1.0-dev+5C.

DEBLOCK4 DESIGN/KNOWLEDGE:
    prevailing MPEG-2 authority ............... v1.05 unless W3X supplies a
                                                 later RATIFIED authority.
    B2 ........................................ primary candidate.
    D ......................................... mandatory comparator/fallback.
    Q14 ....................................... not yet run.
    filtering kernel ......................... DOES NOT EXIST.

ACTIVE WORK:
    T1 documentation consolidation ........... IN PROGRESS.
    a5 ........................................ search/classification settled;
                                                 successor-W3D verification of
                                                 W3C recovery ledger + W3X
                                                 closure remains.
    a5b ....................................... NOT STARTED.

DOWNSTREAM:
    T8 provenance closure ..................... after T1, before T5.
    T5 detector mathematics .................. after T8.
    T6/Q14 planning ........................... after T5; separate ratification.
```

The current development environment remains Zig 0.16.0, portable VapourSynth
R79 with the accepted in-tree API4 compile-header contract, Visual Studio 2026
x64 developer prompt for builds/proof runs, and Visual Studio Code with Zig
extensions for editing.

The current work is therefore **document recovery/review, not implementation**.
No source, build, test, patch or git action follows merely from this status.
...
SHARED / CLASSIC ARC
    ...
    Stage 1C filter creation + integration scaffold ........ COMPLETE
    Stage 2C Classic ReleaseSafe scalar oracle ............ COMPLETE
    Stage 3C ............................................... COLLAPSED
    Stage 4C Classic SSE4.1/x86-64-v2 ..................... COMPLETE
    Stage 5C Classic AVX2/x86-64-v3 ....................... COMPLETE
    Post-5C M1/M2 ......................................... COMPLETE
    Classic ratified integer-tier arc ..................... COMPLETE

DEBLOCK4 PRE-KERNEL ARC
    T1  documentation consolidation ....................... ACTIVE
      a1/a2 ............................................... CLOSED
      a3/a4 ............................................... CLOSED provisionally
      a5 .................................................. RECOVERY CLOSURE
      a5b/a6/a7 ........................................... NOT STARTED
      T1S01b .............................................. NOT STARTED; SCOPES-ONLY
    T8  provenance-gap closure ............................ AFTER T1, BEFORE T5
    T5  detector/features/confidence/UNKNOWN mathematics . AFTER T8
    T6  D4-Q14 experiment plan ............................ AFTER T5; separately ratified
    Q14 experiment ........................................ NOT YET RUN

DEBLOCK4 KERNEL / BACKEND ARC
    scalar mathematics/oracle ............................. BLOCKED BY Q14
    quality/schedule decisions ............................ BLOCKED BY PRIOR GATES
    v2/v3 vector backends ................................. BLOCKED BY SCALAR ORACLE
    integration/release validation ........................ FUTURE
```

The old shorthand `Stage 2D..5D = grids/schedules/midpoint/chroma` is no longer
current architecture. In particular the old midpoint machinery belongs to
rejected Architecture A. The future Deblock4 scalar/kernel sequence must be
re-derived from the architecture W3X allows to advance after Q14.
...
For current recovery/orientation, use **highest committed versions** unless a
current W3X message supplies a newer explicit artifact. Do not reconstruct a
package from the old Phase-3a pins formerly listed here.

```text
FIRST - LIVE T1 RECOVERY / ROUTING
    Deblock4_T1_Resume_Brief ................ section 0a first
    Deblock4_Standing_Task_Register_T_Series . current work queue + decision log
    T1S00_A_Scope_Manifest .................. frozen frame + delivery routing
    T1S01a5_A_Classification_Repair_v1_1.md .. final W3D classification repair
    T1S01a5_A_Ledger_Body_Part1_v1_4.md ...... W3C recovery candidate ONLY

ROLE ORIENTATION
    111_New_Chat_Introduction_for_Designer ... highest committed
    222-INITIAL_BLURB_FOR_DESIGNER_CHAT ....... highest committed
    111_New_Chat_Introduction_for_Coder ....... highest committed
    222-INITIAL_BLURB_FOR_CODER_CHAT .......... highest committed
    333_W3X_*_Communication_Convention ........ highest committed

CONTROLLING / APPLICABLE PROJECT MATERIAL
    AI_Charter_and_Invariants_Card ............ highest committed; PREVAILS
    Deblock4_MPEG2_Deblocking_Investigation_and_Decided_Architecture_v1_05.md
        prevailing MPEG-2 authority unless W3X supplies a later RATIFIED one
    README_Deblock4_Design_Spec ................ current applicable generation
    Deblock4_Verification_And_Tiering_Decisions current applicable generation
    Deblock4_Toolchain_Findings ................ current applicable generation
    Deblock4_Stage_2C_D0_Preface_and_Binding_Knowledge_Index
                                                 current applicable generation
    Deblock4_Session_Bootstrap_Header .......... highest committed

CURRENT APPLICABILITY WARNINGS
    T1/ .................. process/workshop; not applicable knowledge itself
    GAIS_investigations/ . ignored for T1 search/adjudication
    superseded*/scheduled_for_deletion* ........ excluded from current use
```

The a5 recovery ledger v1.4 is intentionally labelled by authorship. A successor
must not mistake its presence in the package for an independent W3C review of a
W3D artifact.
...
**Do not implement anything. Do not start T1S01a5b yet.**

The immediate bounded action is the a5 recovery-verification/closure loop:

1. Successor W3D reads Resume Brief section 0a, the task-register decision log,
   delivered ledger v1.3, Classification Repair v1.1, and W3C recovery ledger
   v1.4.
2. W3D independently verifies the recovery reconstruction against that evidence
   chain and either adopts/reissues a W3D-owned ledger or corrects it.
3. W3X then decides the one-off a5 closure route. The clean default is to use
   successor W3D as the independent verifier of the W3C-authored recovery
   artifact rather than asking W3C to certify its own reconstruction.
4. Only after W3X closes a5 does W3D begin T1S01a5b (authority sections 9-13).

No new a5 search/classification round is indicated unless the independent
recovery check exposes a concrete defect requiring one.

When a new W3C session is first asked to participate in a5, W3X must tell it
**before review begins** that ledger v1.4 was authored by W3C as a recovery
reconstruction. It must not describe a later W3C read as an independent review
of that same W3C-authored artifact.

After T1 completes, the current high-level route is T8 -> T5 -> separately
ratified T6/Q14 planning. No Deblock4 kernel scope exists before Q14.
# 13. Revision history

```text
v1.35 (2026-08-21) T1S01a5 CLOSURE and the recovery arc's end. Records DEC-85
     cap-and-carry and DEC-88 closure; final ledger v1.10 (44 entries, all
     Tier C, W3C-reproduced); the DEC-70 resolution of v1.34's expected gate
     (recovery ledger v1.4 ruled out, textual rebuild on v1.3); Review Scope
     v1.15 as the ratified consolidated method; residue R1-R8 routed at
     register 0c; and the one-pass continuity refresh this version is part
     of. Prior section 0 demoted to 0-prior with an OVERTAKEN banner.
v1.34 (2026-08-19) Recovery/state reconciliation after the preceding W3D
      chat reached its session limit. Records Classification Repair v1.1 as
      complete, the W3C-authored a5 recovery ledger v1.4 as a recovery
      candidate requiring successor-W3D independent verification, and a5b as
      gated on W3X closure. Separates 47-document frozen T1S00 survey,
      41-document current adjudication and 46-file settled a5 search snapshot;
      records T1/ and GAIS_investigations/ applicability rules; updates the
      live sequence to T1 -> T8 -> T5 -> separately-ratified T6/Q14; replaces
      stale body sections 3, 6, 10 and 12 so a cold reader no longer lands in
      Stage-1C Phase-3a instructions. No code/architecture change and no
      authority remedy ratified by this status bump.
...
*This document is informative and non-controlling. The charter prevails; the
ratified MPEG-2 authority prevails for MPEG-2/Deblock4 matters; binding active
scopes govern bounded implementation work. This file records state only.*
