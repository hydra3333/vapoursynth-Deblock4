...
## 2.4a `Deblock4_Verification_And_Tiering_Decisions_v1_8.md` - INFORMATIVE DURABLE RECORD
...
2. Whether the attached charter filename and internal version both identify
   ratified v1.15; stop on any mismatch. (A future successor document is
...
v1.7  Mechanical review corrections: README reading focus and the cleanup
      ...
      decisions ref v1.5 -> v1.7; added a required-reading entry (2.4a) for the
      decisions record.
