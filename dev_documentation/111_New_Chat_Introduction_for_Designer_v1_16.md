...
Current position (2026-08-02, end of session; verify against repo):
    ...
    short-boundary W3D deliverables with a W3X checkpoint after each:
      D0 Preface + Binding Knowledge Index: COMMITTED, latest
         ...
         hash). Section 5 records the SETTLED non-mod-8 boundary policy
         ...
         as new K-numbers.
      D1 Pinned reference snapshot: COMMITTED at
      ...
      D2 HolyWu Real Schedule: DELIVERED and VERIFIED. Latest
         Deblock4_Stage_2C_D2_HolyWu_Real_Schedule_v1_2.md (v1_2 resolves
         W3C verification findings F1-F11). Verified core (W3C PASS):
...
Immediate designer action:
    D0 v1_4, D2 v1_2, D3 v1_1 are the current reference set (cite highest
    versions). D2 verification is RESOLVED (F1-F11 applied; F12 became
    K26). NEXT: author the D4 Stage 2C coder scope from D2 v1_2 + D3 v1_1,
