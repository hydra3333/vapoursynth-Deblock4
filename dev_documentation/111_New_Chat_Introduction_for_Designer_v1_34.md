...
DESIGNER ROLE NOW:
 ...
 - Next designer work is T1S01a5b, NOT a5 AND NOT T8/T5/T6. T1S01a5 IS
   CLOSED - 2026-08-21, DEC-85 (cap-and-carry) and DEC-88. Final ledger
   v1.10: 44 entries, ALL Tier C, every headline figure independently
   reproduced by W3C. It closed WITH KNOWN RESIDUE R1-R8, enumerated and
   ROUTED at Standing Task Register v1.36 section 0c. DO NOT OPEN AN a5
   CORRECTION GENERATION FOR ANY OF IT - there is no v1.11 and will not be;
   if you find yourself reasoning toward "just one more a5 fix", stop and
   re-read DEC-85 and DEC-88.
   (History, so you do not re-derive it: a designer chat death led to a W3C
   recovery ledger v1.4, RULED OUT at DEC-70; the rebuild on delivered v1.3
   then took seven W3C review rounds to close. NOT ONE MPEG-2 conclusion was
   overturned in any round.)
   ...
   THE BINDING REVIEW SCOPE IS Deblock4_T1_W3C_Review_Scope_v1_15 - the
   RATIFIED consolidated method (DEC-83/84). Read its section 0 end to end
   before writing ONE a5b entry.
   THE a5b PRE-ADJUDICATION OBLIGATIONS ARE ALREADY DISCHARGED - DO NOT REDO
   THEM. The population derivation and source-coverage map (DEC-77 / scope
   0.10) exist as T1/T1S01a5b_A_Population_and_Coverage_Map_v1_0.md: 40
   declared files, full walk of lines 716-1098, reserved entries
   LED-064..LED-097, seven split-candidate flags, two pre-identified
   CITED-OUTSIDE-RANGE obligations. YOUR FIRST ACT is verifying the
   committed tree against the map's section A.3 (it was derived conditional
   on the 2026-08-21 refresh commit); tree matches -> adjudicate in map
   order, in bounded batches; tree differs -> re-derive the POPULATION ONLY
   under the map's own rules and record the delta. Resume Brief sections 0a
   and 0f carry the a5b expectations - it is the HARDER, architecture-heavy
   half.
 - KEEP THE FOUR T1 POPULATION NUMBERS DISTINCT. The frozen T1S00 SURVEY
...
v1.33 (2026-08-21) Deep-staleness sweep after a W3X-requested fitness check.
      ...
      awaiting a delta review, the state list still said the ledger rewrite
      was next, the population rule said THREE numbers, and the manifest note
      still queued a bump that had long happened. That is the
      partial-replacement failure this document itself warns about, committed
      in the document's own refresh. All five sites (including the
      produce-the-map instruction, superseded by the delivered
      T1/T1S01a5b_A_Population_and_Coverage_Map_v1_0.md) now state the
      closed-a5 / active-a5b state, and the population rule counts FOUR.
v1.32 (2026-08-21) a5 CLOSURE refresh. Next-work block replaced: a5 CLOSED
      (DEC-85/88, final ledger v1.10, 44 entries all Tier C, residue R1-R8
      routed at register 0c, no further a5 rounds); next designer work is
      a5b under RATIFIED Review Scope v1.15 with a source-coverage map owed
      BEFORE adjudication. Also corrects this file's own header metadata,
      which had staled at v1.30/2026-08-19 inside the v1.31 file - an
      R4-class defect found during this refresh.
...
2b. T1S00_A_Scope_Manifest - HIGHEST COMMITTED VERSION        T1 PROCESS
    ...
    search/adjudication populations. Its current-status paragraph is
    maintained by DEC-69 delivery-only bumps and already records the a5
    closure; the frozen frame itself never changes.
...
- T1 CONSOLIDATION SWEEP - IN PROGRESS, and it comes before everything below.
  ...
  Current state: T1S01a5 (authority sections 1-8) is CLOSED - DEC-85/88,
  final ledger v1.10, 44 entries, all Tier C, residue R1-R8 routed at
  register 0c. T1S01a5b (sections 9-13) is the ACTIVE sub-tranche; its
  population and coverage map are delivered (see the a5b block near the top
  of this document) and adjudication of LED-064..LED-097 is the work.
  NOTHING has been ratified into the authority document - ledger remedies
...
5. Immediate designer action: THE T1 CONSOLIDATION SWEEP, unless W3X directs
   ...
   CURRENT ENDPOINT: T1S01a5 CLOSED (DEC-85/88), final ledger v1.10, 44
   entries, all Tier C. The active work is a5b ADJUDICATION against the
   delivered coverage map, first verifying the committed tree against the
   map's A.3 population. Not another a5 round of any kind, not another
   search round, and not another Tier C sample.
