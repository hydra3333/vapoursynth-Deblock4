...
T1S01a5 - the first and largest ledger sub-tranche of the MPEG-2 authority's
body - CLOSED on 2026-08-21 (decisions DEC-85 and DEC-88). Its final ledger
(v1.10) holds 44 adjudicated entries, all Tier C, with every headline figure
independently reproduced by the coder chat. It closed under a deliberate
cap-and-carry rule: a small enumerated residue (R1-R8) is ROUTED at the
Standing Task Register section 0c to later tranches rather than chased, and
no further a5 correction round is permitted. Across the seven review rounds
it took to get there, NOT ONE MPEG-2 conclusion was overturned - the cost was
process, not substance. NEXT: T1S01a5b (authority sections 9-13) under the
now-RATIFIED consolidated review method (Review Scope v1.15).
...
T1            IN PROGRESS. Formal consolidation sweep of the MPEG-2-bearing
              ...
              a5 CLOSED (DEC-85/88); final ledger v1.10, 44 entries, all
              Tier C; residue R1-R8 routed at register 0c.
              a5b is NEXT; a6/a7 have not started.
...
Immediate process gate: NONE - the a5 recovery is over (the W3C recovery
ledger v1.4 route was ruled out at DEC-70; closure came via a textual rebuild
on the delivered v1.3 basis and seven review rounds). The next work is
**T1S01a5b**, which must derive its own document population and produce a
source-coverage map BEFORE adjudication (DEC-77).
...
Development priority from here: finish
...
v1.8 (2026-08-21) T1S01a5 closure refresh. Records a5 CLOSED (DEC-85/88) with
     final ledger v1.10 (44 entries, all Tier C, coder-reproduced), the
     DEC-70 resolution of the recovery route, residue R1-R8 routed at
     register 0c, the zero-overturned-conclusions record, and a5b as next
     under ratified Review Scope v1.15.
v1.7 (2026-08-19) Delivered with the recovery-closure batch; minor
     currentisation of the v1.6 state.
