...
"Classic: float input is not supported" (table v1_2+), proved by an
...
K16    O-1b encodes the ratified Classic offset-REJECTION obligations
       (never clamp). Creation-error table v1_2+ ADDS the two ratified
       Stage 2C rows (float refusal; backend-unavailable refusal) under
       the D0 section-5 exception; no EXISTING string or using-echo
       surface is altered.
...
Revision: v1.5 (2026-08-03) aligned with the ratified D4 decisions (W3C
