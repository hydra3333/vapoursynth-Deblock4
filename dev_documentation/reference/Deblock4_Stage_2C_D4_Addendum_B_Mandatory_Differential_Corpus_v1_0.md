...
Run through Classic ONLY (HolyWu not involved); these prove the S1/S5
rows and the ratified precedence:

```text
N01  YUV444PS (float)                -> "Classic: float input is not
                                        supported"
N02  backend="x86_64_v2_with_sse41"  -> "Classic: requested backend is
...
Revision: v1.0 (2026-08-03). 17 mandatory comparison cases + 4 refusal/
precedence cases; all NV bounds model-verified.
