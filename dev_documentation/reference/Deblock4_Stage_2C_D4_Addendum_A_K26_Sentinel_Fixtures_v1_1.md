...
v1_2 H3(b), so the K26 signed-shift behavioural sentinels (B2/B5: negative-LEFT-shift
...
Revision: v1.1 (2026-08-03) W3C updated-package F6: purpose line uses the
