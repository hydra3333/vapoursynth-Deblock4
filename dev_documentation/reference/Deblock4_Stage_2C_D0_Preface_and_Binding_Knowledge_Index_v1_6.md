...
false claims once it produces pixels - specifically the float-input
refusal and the unimplemented-backend refusal carried by creation-error
table v1_2 - and NO other validation or creation-string change. All
...
Revision: v1.6 (2026-08-03) W3C combined-review sweep applied: added K27
