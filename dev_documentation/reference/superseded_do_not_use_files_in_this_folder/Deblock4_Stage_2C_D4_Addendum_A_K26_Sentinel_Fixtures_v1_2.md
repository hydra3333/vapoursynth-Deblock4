...
**Date:** 2026-08-03
**Author:** W3D
**Purpose:** supply the exact plugin-level sentinel fixtures required by
D4 H3(b) (version-neutral: the highest committed D4), so the K26 signed-shift behavioural sentinels (B2/B5: negative-LEFT-shift
UB region; B4: negative RIGHT shift in the side-delta) are reproducible
...
Revision: v1.2 (2026-08-03) W3C v1.4-package review F6.2: purpose cites
D4 H3(b) version-neutrally. v1.1 (2026-08-03) W3C updated-package F6: purpose line uses the
K26 signed-shift naming with B4 distinguished (section 7 already correct).
v1.0 (2026-08-03) initial fixtures, six in total (three vectors
