...
K17  this directory is W3X-owned and READ-ONLY: coder deliveries never
     read as input, modify, move, or EOL-normalise it.
...
Revision: v1.1 (2026-08-03) added sections 5-6 and qualified the oracle
