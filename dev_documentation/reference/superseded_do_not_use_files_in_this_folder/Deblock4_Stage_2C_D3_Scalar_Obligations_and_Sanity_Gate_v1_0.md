...
K16    no creation-string or using-echo surface is touched by O-items.
...
Revision: v1.0 (2026-08-02). Authored in parallel with the coder's D2
verification; to be amended if D2 findings touch any derivation, then
reviewed by W3C together with D4 (ratified review plan).
