...
**Date:** 2026-08-03
**Author:** W3D (designer)
**Status:** RELEASED. W3X called the v1.5-package review FINAL and ratified
and released this scope 2026-08-03. This v1_7 is an issuance-hygiene REISSUE
(released status recorded; charter C-DELIV-09 reminder block added; one
checklist-heading pointer refreshed) with NO technical content change. Read
with D3 v1_8. W3X alone releases, accepts and commits.
**Built from:** D0 v1_9, D1 (pinned r9 snapshot + provenance v1.4),
D2 v1_6, D3 v1_8, and Addendum A v1.2 (K26 sentinel fixtures) + Addendum
...
IN SCOPE
  ...
  5. Tests asserting EVERY D3 v1_8 obligation on its routed proof
...
OUT OF SCOPE (do not touch, do not "improve")
  ...
  - Parameter validation, creation-error strings and tier RESOLUTION are
    unchanged EXCEPT the five narrowly authorised items (D0 v1_9 section
...
S4  ORACLE STATUS. Per the oracle-construction exception (charter G7;
    V&T 20.2; K9), this delivery is accepted against D3 v1_8's
...
Implement exactly what D2 v1_6 documents; D3 v1_8 judges it. The
...
D3 v1_8 in full: O-1, O-1b, O-1c (73 enumerated tuple cases + the
...
# 9. Binding Knowledge Checklist (D0 v1_9)
...
Review THIS scope together with D3 v1_8 and Addenda A v1.2 and B v1.2. Report numbered findings on:
