...
differential harness):
    ...
    exact reference DLL/executable run, and K26 signed-shift behavioural
    sentinel fixtures (B2/B5 probe the negative-LEFT-shift UB region;
    B4 probes a negative RIGHT shift in the side-delta) with observed
    outputs; D4 Addendum A is the plugin-level fixture authority. Any rebuilt reference
...
# 6. Binding Knowledge Checklist (added v1.1, W3C F7; index at D0 v1_8)
...
Revision: v1.4 (2026-08-03) W3C v1.4-package review F6.3: checklist
heading references the current D0 v1_8 index. v1.3 (2026-08-03) W3C
updated-package F6: sentinel wording
corrected to K26 signed-shift with B4 distinguished. v1.2 (2026-08-03)
narrowed the no-read rule to admit the D4 H0
