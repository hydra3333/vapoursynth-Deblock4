...
//
// build.zig.zon remains the permitted package-manifest mirror. The whole-plugin
// proof verifies that mirror against semantic_version.
pub const semantic_version = "0.1.0-dev";
pub const stage_marker = "4C";
...
test "version representations remain internally consistent" {
    ...
    try std.testing.expectEqualStrings("4C", stage_marker);
